(module
  ...
  (func $feigenbaum (type 7)
    (local i32 i32 f64 f64 i32 f64 i32 f64 f64 i32 f64 i32)
    (global.set 0
      (local.tee 0
        (i32.sub
          (global.get 0)
