(module
  ...
  (func $putchar (type 5) (param i32) (result i32)
    ...
    (call $__overflow
      (i32.const 3552)
      (local.get 1)))
  (func $log10 (type 16) (param f64) (result f64)
    ...
    (local.get 0))
  (func $sieve_check (type 3) (param i32 i32) (result i32)
    (local i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
      ...
      (local.set 2
        (i32.eqz
          (i32.and
            ...
            (i32.const 1)))))
    (local.get 2))
  (func $sieve (type 5) (param i32) (result i32)
            ...
            (f64.convert_i32_u
              (local.tee 3
                (i32.add
                  ...
                  (i32.const 2))))))))
    (local.get 1))
  (func $ulam_get_map (type 0) (param i32 i32 i32) (result i32)
    (local i32 f64)
    (local.set 1
      (i32.shl
        (local.tee 3
    ...
    (block  ;; label = @3
      ...
      (return
        (i32.trunc_f64_s
          (local.get 4))))
    (i32.const -2147483648))
  (func $output_ulam_spiral (type 10) (param i32 i32)
  ...
  (export "sieve_check" (func $sieve_check))
  (export "sieve" (func $sieve))
  (export "ulam_get_map" (func $ulam_get_map))
  (export "output_ulam_spiral" (func $output_ulam_spiral))
