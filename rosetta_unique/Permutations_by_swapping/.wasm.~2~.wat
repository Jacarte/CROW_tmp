(module
  ...
  (func $atoi (type 5) (param i32) (result i32)
    ...
    (select
      ...
      (i32.sub
        ...
        (local.get 2))
      (local.get 4)))
  (func $heapPermute (type 14) (param i32 i32 i32)
    (local i32 i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 3
        (i32.sub
  ...
  (global (;21;) i32 (i32.const 3828))
  (global (;22;) i32 (i32.const 1024))
  (global (;23;) i32 (i32.const 5484))
  ...
  (export "heapPermute" (func $heapPermute))
  (export "flag" (global 21))
