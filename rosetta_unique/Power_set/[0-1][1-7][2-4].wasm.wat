  ...
  (func $puts (type 5) (param i32) (result i32)
    ...
    (i32.shr_s
      (call $__overflow
        ...
        (i32.const 10))
      (i32.const 31)))
  (func $powerset (type 14) (param i32 i32 i32)
    (local i32)
    (global.set 0
      (local.tee 3
        (i32.sub
