(module
  ...
  (func $frexp (type 15) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $StoogeSort (type 14) (param i32 i32 i32)
    (local i32 i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.ge_s
