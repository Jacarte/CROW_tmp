  ...
  (func $__overflow (type 5) (param i32 i32) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (local.get 3))
  (func $fputc (type 5) (param i32 i32) (result i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eq
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $quib (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32)
    (local.set 2
      (select
        (i32.add
              ...
              (block  ;; label = @9
                ...
                (i32.store8
                  (i32.add
                    (local.get 1)
                    (i32.const 2))
                  (i32.load8_u offset=3562
                    (i32.const 0)))
                (i32.store16 align=1
                  (local.get 1)
                  (i32.load16_u offset=3560 align=1
                    (i32.const 0)))
                (br 1 (;@8;)))
              (i32.store16 align=1
                (i32.add
                  (local.get 1)
                  (i32.const 4))
                (i32.load16_u offset=3567 align=1
                  (i32.const 0)))
              (i32.store align=1
                (local.get 1)
                (i32.load offset=3563 align=1
                  (i32.const 0))))
            (drop
              (call $strcat
                (local.get 3)
