(module
  ...
  (func $atoi (type 5) (param i32) (result i32)
    ...
    (select
      ...
      (i32.sub
        ...
        (local.get 2))
      (local.get 4)))
  (func $doublyEvenMagicSquare (type 5) (param i32) (result i32)
  ...
  (export "doublyEvenMagicSquare" (func $doublyEvenMagicSquare))
