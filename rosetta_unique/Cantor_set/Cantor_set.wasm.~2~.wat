(module
      ...
      (br_if 0 (;@1;)
        (i32.and
          (i32.ne
            ...
            (i32.const 0))
          (i32.const 1)))))
  (func $cantor (type 14) (param i32 i32 i32)
    (local i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
  ...
  (global (;21;) i32 (i32.const 5424))
  (global (;22;) i32 (i32.const 1024))
  (global (;23;) i32 (i32.const 5829))
  ...
  (export "cantor" (func $cantor))
  (export "print" (func $print))
  (export "lines" (global 21))
