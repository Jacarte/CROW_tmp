(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 64)))
    (i32.const 0))
  (func $show (type 14) (param i32 i32 i32)
    (local i32)
    (global.set 0
      (local.tee 3
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 3)
        (i32.const 32))))
  (func $sort (type 10) (param i32 i32)
    ...
    (global.set 0
      (i32.add
        (local.get 3)
        (i32.const 32))))
  (func $removehead (type 4) (param i32) (result i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
      ...
      (i32.store offset=4
        ...
        (i32.const 0)))
    (local.get 1))
  (func $push (type 10) (param i32 i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.load
    ...
    (i32.store offset=4
      (local.get 0)
      (local.get 1)))
  (func $merge (type 10) (param i32 i32)
    (local i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 2)
        (i32.const 16))))
  (func $join (type 10) (param i32 i32)
    (call $push
      (local.get 0)
      (i32.load
        (local.get 1)))
  ...
  (export "removehead" (func $removehead))
