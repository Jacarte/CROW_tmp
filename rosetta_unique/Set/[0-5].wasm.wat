  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 64)))
    (i32.const 0))
  (func $show_set (type 10) (param i32 i32)
    (local i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
