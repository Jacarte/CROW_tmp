  ...
  (func $atoi (type 5) (param i32) (result i32)
    ...
    (select
      ...
      (i32.sub
        ...
        (local.get 2))
      (local.get 4)))
  (func $cartesianProduct (type 16) (param i32 i32 i32 i32 i32)
    (local i32 i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 5
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 5)
        (i32.const 16))))
  (func $printSets (type 14) (param i32 i32 i32)
    (local i32 i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 3
        (i32.sub
