(module
  ...
  (func $frexp (type 15) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $checkAndUpdateLetterList (type 10) (param i32 i32)
    (local i32 i32 i32 i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
  ...
  (global (;21;) i32 (i32.const 5628))
  (global (;22;) i32 (i32.const 5624))
  (global (;23;) i32 (i32.const 1024))
  (global (;24;) i32 (i32.const 5629))
  (global (;25;) i32 (i32.const 1024))
  (global (;26;) i32 (i32.const 71168))
  ...
  (export "checkAndUpdateLetterList" (func $checkAndUpdateLetterList))
  (export "printLetterList" (func $printLetterList))
  (export "duplicatesFound" (global 21))
  (export "letterSet" (global 22))
