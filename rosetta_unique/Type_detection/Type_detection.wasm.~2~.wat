(module
  ...
  (func $frexp (type 15) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $isalnum (type 5) (param i32) (result i32)
    (i32.or
      (i32.lt_u
        (i32.add
          (local.get 0)
      ...
      (i32.lt_u
        (i32.add
          ...
          (i32.const -97))
        (i32.const 26))))
  (func $__isalnum_l (type 3) (param i32 i32) (result i32)
    (i32.or
      (i32.lt_u
        (i32.add
          (local.get 0)
      ...
      (i32.lt_u
        (i32.add
          ...
          (i32.const -97))
        (i32.const 26))))
  (func $iscntrl (type 5) (param i32) (result i32)
    (i32.or
      (i32.lt_u
        (local.get 0)
        (i32.const 32))
      (i32.eq
        (local.get 0)
        (i32.const 127))))
  (func $__iscntrl_l (type 3) (param i32 i32) (result i32)
    (i32.or
      (i32.lt_u
        (local.get 0)
        (i32.const 32))
      (i32.eq
        (local.get 0)
        (i32.const 127))))
  (func $ispunct (type 5) (param i32) (result i32)
    (local i32)
    (local.set 1
      (i32.const 0))
    (block  ;; label = @1
      ...
      (local.set 1
        (i32.eqz
          (call $isalnum
            (local.get 0)))))
    (local.get 1))
  (func $__ispunct_l (type 3) (param i32 i32) (result i32)
    (local i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
      ...
      (local.set 2
        (i32.eqz
          (call $isalnum
            (local.get 0)))))
    (local.get 2))
  (func $isxdigit (type 5) (param i32) (result i32)
    (i32.or
      (i32.lt_u
        (i32.add
          (local.get 0)
      ...
      (i32.lt_u
        (i32.add
          ...
          (i32.const -97))
        (i32.const 6))))
  (func $__isxdigit_l (type 3) (param i32 i32) (result i32)
    (i32.or
      (i32.lt_u
        (i32.add
          (local.get 0)
      ...
      (i32.lt_u
        (i32.add
          ...
          (i32.const -97))
        (i32.const 6))))
  (func $typeDetector (type 2) (param i32)
    (local i32 i32)
    (global.set 0
      (local.tee 1
        (i32.sub
  ...
  (export "__iscntrl_l" (func $__iscntrl_l))
  (export "iscntrl_l" (func $__iscntrl_l))
  (export "isalnum" (func $isalnum))
  (export "__isalnum_l" (func $__isalnum_l))
  (export "isalnum_l" (func $__isalnum_l))
  (export "isxdigit" (func $isxdigit))
  (export "__isxdigit_l" (func $__isxdigit_l))
  (export "isxdigit_l" (func $__isxdigit_l))
  (export "ispunct" (func $ispunct))
  (export "__ispunct_l" (func $__ispunct_l))
  (export "ispunct_l" (func $__ispunct_l))
  (export "typeDetector" (func $typeDetector))
