(module
  ...
  (func $frexp (type 16) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $asin (type 17) (param f64) (result f64)
  ...
  (func $__rem_pio2 (type 19) (param f64 i32) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 48)))
    (local.get 4))
  (func $__cos (type 20) (param f64 f64) (result f64)
    (local f64 f64 f64)
    (f64.add
      (local.tee 4
        (f64.sub
      ...
      (f64.add
        ...
        (f64.sub
          ...
          (f64.mul
            (local.get 0)
            (local.get 1))))))
  (func $sin (type 17) (param f64) (result f64)
    (local i32 i32)
    (global.set 0
      (local.tee 1
        (i32.sub
  ...
  (func $__original_main (type 13) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $sin_call (type 2) (param i32 f64) (result f64)
    (call $sin
      (local.get 1)))
  (func $asin_call (type 2) (param i32 f64) (result f64)
    (call $asin
      (local.get 1)))
  (func $compose (type 6) (param i32 i32) (result i32)
    (local i32)
    (i32.store
      (local.tee 2
        (call $malloc
    ...
    (i32.store offset=8
      ...
      (local.get 1))
    (local.get 2))
  (func $compose_call (type 2) (param i32 f64) (result f64)
    (local i32 i32)
    (local.set 3
      (i32.load
        (local.tee 2
  ...
  (table (;0;) 8 8 funcref)
  (memory (;0;) 2)
  (global (;0;) (mut i32) (i32.const 73808))
  ...
  (global (;17;) i32 (i32.const 6608))
  (global (;18;) i32 (i32.const 6488))
  (global (;19;) i32 (i32.const 7228))
  (global (;20;) i32 (i32.const 3516))
  (global (;21;) i32 (i32.const 1024))
  (global (;22;) i32 (i32.const 8264))
  (global (;23;) i32 (i32.const 1024))
  (global (;24;) i32 (i32.const 73808))
  ...
  (export "compose_call" (func $compose_call))
  (export "compose" (func $compose))
  (export "sin_call" (func $sin_call))
  (export "asin_call" (func $asin_call))
