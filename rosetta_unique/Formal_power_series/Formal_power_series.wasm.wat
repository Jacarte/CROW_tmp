(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 64)))
    (i32.const 0))
  (func $fps_const (type 16) (param f64) (result i32)
    (local i32)
    (f64.store offset=16
      (local.tee 1
        (call $fps_new))
    ...
    (i32.store
      ...
      (i32.const 0))
    (local.get 1))
  (func $fps_new (type 12) (result i32)
    (local i32)
    (i32.store offset=8
      (local.tee 0
        (call $malloc
    ...
    (i64.store
      ...
      (i64.const 0))
    (local.get 0))
  (func $_unary (type 5) (param i32 i32) (result i32)
    (local i32)
    (i32.store
      (local.tee 2
        (call $fps_new))
    ...
    (i32.store offset=4
      ...
      (local.get 0))
    (local.get 2))
  (func $_binary (type 0) (param i32 i32 i32) (result i32)
    (local i32)
    (i32.store offset=8
      (local.tee 3
        (call $fps_new))
    ...
    (i32.store
      ...
      (local.get 2))
    (local.get 3))
  (func $fps_redefine (type 11) (param i32 i32 i32 i32)
    (i32.store offset=8
      (local.get 0)
      (local.get 3))
    (i32.store offset=4
    ...
    (i32.store
      (local.get 0)
      (local.get 1)))
  (func $term (type 17) (param i32 i32) (result f64)
    (local i32 i32 f64)
    (global.set 0
      (local.tee 2
        (i32.sub
            ...
            (block  ;; label = @5
              (block  ;; label = @6
                (block  ;; label = @7
                  (block  ;; label = @8
                    (block  ;; label = @9
                      (br_table 1 (;@8;) 7 (;@2;) 2 (;@7;) 0 (;@9;) 3 (;@6;) 4 (;@5;) 5 (;@4;) 6 (;@3;)
                        (local.tee 3
                          (i32.load
                            (local.get 0)))))
                    (local.set 3
  ...
  (export "fps_new" (func $fps_new))
  (export "fps_redefine" (func $fps_redefine))
  (export "_binary" (func $_binary))
  (export "_unary" (func $_unary))
  (export "term" (func $term))
  (export "fps_const" (func $fps_const))
