  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 64)))
    (i32.const 0))
  (func $intcmp (type 2) (param i32 i32) (result i32)
    (select
      (i32.const -1)
      (i32.gt_s
        (local.tee 0
