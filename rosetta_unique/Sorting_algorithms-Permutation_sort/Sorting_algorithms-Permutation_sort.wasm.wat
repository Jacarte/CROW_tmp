(module
  ...
  (func $scmp (type 2) (param i32 i32) (result i32)
    (call $strcmp
      ...
      (i32.load
        (local.get 1))))
  (func $perm_sort (type 11) (param i32 i32 i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    (local.set 4
      (i32.shl
        (local.get 2)
  ...
  (export "perm_sort" (func $perm_sort))
