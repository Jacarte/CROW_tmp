(module
  ...
  (func $doSeq (type 2) (param i32)
    ...
    (global.set 0
      (i32.add
        (local.get 1)
        (i32.const 80))))
  (func $genSeq (type 10) (param i32 i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
    ...
    (i32.store8
      (i32.add
        ...
        (i32.shl
          ...
          (i32.const 1)))
      (i32.const 0)))
  (func $isBal (type 5) (param i32 i32) (result i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (local.get 1))
  ...
  (export "isBal" (func $isBal))
  (export "shuffle" (func $shuffle))
  (export "genSeq" (func $genSeq))
  (export "doSeq" (func $doSeq))
