      ...
      (i32.add
        ...
        (local.tee 1
          (i32.shr_s
            ...
            (i32.const 31))))
      (local.get 1)))
  (func $labs (type 5) (param i32) (result i32)
    (local i32)
    (i32.xor
      (i32.add
        (local.get 0)
