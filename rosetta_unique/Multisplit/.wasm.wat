(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $parse_sep (type 14) (param i32 i32 i32)
    (local i32 i32 i32 i32)
    (global.set 0
      (local.tee 3
        (i32.sub
  ...
  (export "parse_sep" (func $parse_sep))
