  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 80)))
    (i32.const 0))
  (func $mean (type 16) (param i32 i32) (result f64)
    (local f64 i32)
    (local.set 2
      (f64.const 0x0p+0 (;=0;)))
    (block  ;; label = @1
