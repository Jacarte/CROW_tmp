  ...
  (func $__original_main (type 12) (result i32)
    ...
    (i64.store
      (i32.add
        (local.get 0)
        (i32.const 32))
      (i64.const 146028888098))
    (i64.store
      (i32.add
        (local.get 0)
        (i32.const 24))
      (i64.const 395136991324))
    (i64.store
      (i32.add
        (local.get 0)
        (i32.const 16))
