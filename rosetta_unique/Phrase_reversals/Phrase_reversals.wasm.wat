(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 128)))
    (i32.const 0))
  (func $reverse_string (type 4) (param i32) (result i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
          (local.tee 1
            (call $strlen
              (local.get 0)))))
      (drop
        (call $reverse_section
          (local.get 0)
          (i32.add
            (local.get 1)
            (i32.const -1)))))
    (local.get 0))
  (func $reverse_words_in_order (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
      ...
      (local.set 0
        (i32.add
          ...
          (i32.const -1))))
    (local.get 0))
  (func $reverse_order_of_words (type 5) (param i32 i32) (result i32)
    (drop
      (call $reverse_string
        (local.get 0)))
    (drop
      (call $reverse_words_in_order
        ...
        (local.get 1)))
    (local.get 0))
  (func $reverse_section (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
  ...
  (export "reverse_section" (func $reverse_section))
  (export "reverse_words_in_order" (func $reverse_words_in_order))
  (export "reverse_string" (func $reverse_string))
  (export "reverse_order_of_words" (func $reverse_order_of_words))
