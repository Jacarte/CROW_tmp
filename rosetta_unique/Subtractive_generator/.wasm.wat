(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $subrand_seed (type 2) (param i32)
    (local i32 i32 i32 i32)
      ...
      (br_if 0 (;@4;)
        (i32.and
          (i32.ne
            ...
            (i32.const 0))
          (i32.const 1)))))
  (func $subrand (type 12) (result i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
  ...
  (global (;21;) i32 (i32.const 5416))
  (global (;22;) i32 (i32.const 5420))
  (global (;23;) i32 (i32.const 5424))
  (global (;24;) i32 (i32.const 1024))
  (global (;25;) i32 (i32.const 5644))
  ...
  (export "subrand_seed" (func $subrand_seed))
  (export "subrand" (func $subrand))
  (export "si" (global 21))
  (export "sj" (global 22))
  (export "state" (global 23))
