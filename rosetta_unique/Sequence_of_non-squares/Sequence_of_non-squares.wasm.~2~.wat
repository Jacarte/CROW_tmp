(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (call $__assert_fail
      ...
      (i32.const 3574))
    (unreachable))
  (func $nonsqr (type 4) (param i32) (result i32)
    (local f64)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
