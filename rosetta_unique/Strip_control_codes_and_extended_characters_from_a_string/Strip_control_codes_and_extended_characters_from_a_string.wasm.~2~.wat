(module
  ...
  (func $rand (type 11) (result i32)
    ...
    (i32.wrap_i64
      (i64.shr_u
        (local.get 0)
        (i64.const 33))))
  (func $ascii (type 5) (param i32) (result i32)
    (local i32)
    (local.set 1
      (i32.const 1))
    (block  ;; label = @1
      ...
      (local.set 1
        (i32.const 0)))
    (local.get 1))
  (func $ascii_ext (type 5) (param i32) (result i32)
    (local i32)
    (local.set 1
      (i32.const 1))
    (block  ;; label = @1
      ...
      (local.set 1
        (i32.const 0)))
    (local.get 1))
  (func $strip (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    (global.set 0
      (local.tee 3
        (i32.sub
  ...
  (export "ascii" (func $ascii))
  (export "ascii_ext" (func $ascii_ext))
