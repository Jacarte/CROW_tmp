(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $left (type 10) (param i32 i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
        ...
        (br_if 0 (;@4;)
          (i32.and
            (i32.ne
              ...
              (i32.const 16))
            (i32.const 1))))))
  (func $is_prime (type 4) (param i32) (result i32)
    (local i32 i32 i32 i32)
    (local.set 1
      (i32.const 1))
    (block  ;; label = @1
  ...
  (export "left" (func $left))
  (export "right" (func $right))
  (export "maxl" (global 21))
  (export "maxr" (global 22))
