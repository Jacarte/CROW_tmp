(module
  ...
  (func $sqrt2_b (type 2) (param i32) (result f64)
    (f64.const 0x1p+0 (;=1;)))
  (func $calc (type 17) (param i32 i32 i32) (result f64)
    (local f64 f64)
    (local.set 3
      (f64.const 0x0p+0 (;=0;)))
    (block  ;; label = @1
