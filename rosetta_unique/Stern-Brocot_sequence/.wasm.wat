  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 32)))
    (i32.const 0))
  (func $f (type 4) (param i32) (result i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.lt_u
      ...
      (local.set 0
        (i32.add
          ...
          (local.get 0))))
    (local.get 0))
  (func $find (type 10) (param i32 i32)
    (local i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
