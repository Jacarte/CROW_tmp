(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $get_list (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (local.get 3))
  (func $__isspace (type 4) (param i32) (result i32)
    (i32.or
      (i32.eq
        (local.get 0)
        (i32.const 32))
      (i32.lt_u
        (i32.add
          ...
          (i32.const -9))
        (i32.const 5))))
  (func $get_rnge (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (local.get 4))
  (func $add_range (type 5) (param i32 i32) (result i32)
    (local i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (local.get 3))
  (func $add_number (type 2) (param i32)
    (local i32)
    (global.set 0
      (local.tee 1
        (i32.sub
  ...
  (export "get_list" (func $get_list))
  (export "get_rnge" (func $get_rnge))
  (export "add_range" (func $add_range))
  (export "add_number" (func $add_number))
