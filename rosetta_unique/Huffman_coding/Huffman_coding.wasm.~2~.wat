(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 1152)))
    (i32.const 0))
  (func $create_huffman_codes (type 4) (param i32) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 4096)))
    (local.get 2))
  (func $inttobits (type 14) (param i32 i32 i32)
    (i32.store8
      (i32.add
        (local.get 2)
        (local.get 1))
        ...
        (br_if 0 (;@2;)
          (i32.and
            (i32.gt_s
              ...
              (i32.const 0))
            (i32.const 1))))))
  (func $free_huffman_codes (type 2) (param i32)
    (local i32)
    (local.set 1
      (i32.const 0))
    (loop  ;; label = @1
    ...
    (call $free
      (local.get 0)))
  (func $_heap_create (type 4) (param i32) (result i32)
    (local i32)
    (i32.store
      (local.tee 1
        (call $malloc
    ...
    (i32.store offset=16
      ...
      (local.get 0))
    (local.get 1))
  (func $_heap_add (type 10) (param i32 i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
    ...
    (call $_heap_sort
      (local.get 0)))
  (func $_heap_remove (type 4) (param i32) (result i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
    ...
    (i32.load
      (i32.add
        ...
        (i32.shl
          (local.get 1)
          (i32.const 2)))))
  (func $_heap_destroy (type 2) (param i32)
    (call $free
      (i32.load
        (local.get 0)))
    (call $free
      (local.get 0)))
  (func $_heap_sort (type 2) (param i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
  ...
  (export "create_huffman_codes" (func $create_huffman_codes))
  (export "free_huffman_codes" (func $free_huffman_codes))
  (export "inttobits" (func $inttobits))
  (export "test" (global 21))
