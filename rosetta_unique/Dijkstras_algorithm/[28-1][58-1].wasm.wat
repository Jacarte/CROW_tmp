(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (call $print_path
      ...
      (i32.const 101))
    (i32.const 0))
  (func $add_edge (type 11) (param i32 i32 i32 i32)
    (local i32)
    (call $add_vertex
      (local.get 0)
      (local.tee 1
    ...
    (i32.store
      (i32.add
        ...
        (i32.shl
          ...
          (i32.const 2)))
      (local.get 2)))
  (func $dijkstra (type 14) (param i32 i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    (local.set 3
      (i32.sub
        (local.get 1)
        ...
        (br_if 0 (;@7;)
          (i32.and
            (i32.ne
              ...
              (i32.const 0))
            (i32.const 1))))))
  (func $print_path (type 10) (param i32 i32)
    (local i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 2)
        (i32.const 16))))
  (func $add_vertex (type 10) (param i32 i32)
    (local i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
      ...
      (i32.store offset=4
        ...
        (i32.add
          (i32.load offset=4
            (local.get 0))
          (i32.const 1)))))
  (func $create_heap (type 4) (param i32) (result i32)
    (local i32 i32)
    (i32.store
      (local.tee 1
        (call $calloc
    ...
    (i32.store offset=8
      ...
      (call $calloc
        ...
        (i32.const 4)))
    (local.get 1))
  (func $push_heap (type 14) (param i32 i32 i32)
    ...
    (i32.store
      (local.get 4)
      (local.get 7)))
  (func $pop_heap (type 4) (param i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    (local.set 2
      (i32.load offset=4
        (local.tee 1
    ...
    (block  ;; label = @1
      ...
      (return
        (local.get 2)))
    (unreachable))
  (func $min (type 6) (param i32 i32 i32 i32) (result i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
  ...
  (export "add_vertex" (func $add_vertex))
  (export "add_edge" (func $add_edge))
  (export "create_heap" (func $create_heap))
  (export "push_heap" (func $push_heap))
  (export "min" (func $min))
  (export "pop_heap" (func $pop_heap))
