(module
  ...
  (import "env" "main" (func $main (type 2)))
  ...
  (func $frexp (type 15) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $crypto_scalarmult_curve25519 (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    (global.set 0
      (local.tee 3
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (local.get 5))
  (func $crypto_scalarmult_curve25519_base (type 2) (param i32 i32) (result i32)
    (call_indirect (type 2)
      (local.get 0)
      (local.get 1)
      (i32.load
        (i32.const 0))))
  (func $crypto_scalarmult_curve25519_bytes (type 11) (result i32)
    (i32.const 32))
  (func $crypto_scalarmult_curve25519_scalarbytes (type 11) (result i32)
    (i32.const 32))
  (func $_crypto_scalarmult_curve25519_pick_best_implementation (type 11) (result i32)
    (i32.const 0))
  (table (;0;) 5 5 funcref)
  (memory (;0;) 2)
  ...
  (export "crypto_scalarmult_curve25519" (func $crypto_scalarmult_curve25519))
  (export "crypto_scalarmult_curve25519_base" (func $crypto_scalarmult_curve25519_base))
  (export "crypto_scalarmult_curve25519_bytes" (func $crypto_scalarmult_curve25519_bytes))
  (export "crypto_scalarmult_curve25519_scalarbytes" (func $crypto_scalarmult_curve25519_scalarbytes))
  (export "_crypto_scalarmult_curve25519_pick_best_implementation" (func $_crypto_scalarmult_curve25519_pick_best_implementation))
