(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (call $free
      (local.get 0))
    (i32.const 0))
  (func $string_repeat (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32)
    (local.set 4
      (local.tee 3
        (call $malloc
