  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $bits (type 16) (param f64) (result i32)
    (local i32 i32 i32 i32 i32 i32)
    (f64.store offset=8
      (local.tee 1
        (i32.sub
