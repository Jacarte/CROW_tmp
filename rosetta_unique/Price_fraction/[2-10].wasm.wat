(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $price_fix (type 16) (param f64) (result f64)
    (local f64 i32)
    (block  ;; label = @1
      (block  ;; label = @2
        (br_if 0 (;@2;)
  ...
  (global (;23;) i32 (i32.const 5752))
  (global (;24;) i32 (i32.const 1024))
  (global (;25;) i32 (i32.const 71296))
