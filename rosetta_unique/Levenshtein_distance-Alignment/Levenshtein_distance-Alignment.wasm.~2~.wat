(module
  ...
  (func $__original_main (type 12) (result i32)
    (call $leven
      ...
      (i32.const 3534))
    (i32.const 0))
  (func $leven (type 10) (param i32 i32)
