(module
  ...
  (func $apollonius_in (type 6) (param i32 i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 f64 i32 f64 i32 i32 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 f64 i32)
    (global.set 0
      (local.tee 4
        (i32.sub
          (global.get 0)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 592)))
    (local.get 9))
  (func $cross (type 19) (param i32 i32) (result f64)
    (f64.sub
      (f64.mul
        (f64.load
          (local.get 0))
