  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 64)))
    (i32.const 0))
  (func $ipow (type 5) (param i32 i32) (result i32)
    (local i32 i32)
    (block  ;; label = @1
      (block  ;; label = @2
        (block  ;; label = @3
    ...
    (call $__assert_fail
      ...
      (i32.const 3614))
    (unreachable))
  (func $dpow (type 15) (param f64 i32) (result f64)
    (local i32 f64)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.ge_s
