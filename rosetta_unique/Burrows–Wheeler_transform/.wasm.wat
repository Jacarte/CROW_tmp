(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 48)))
    (i32.const 0))
  (func $makePrintable (type 10) (param i32 i32)
    (local.set 1
      (call $strcpy
        (local.get 1)
        (local.get 0)))
  ...
  (func $bwt (type 2) (param i32 i32) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (local.get 4))
  (func $ibwt (type 10) (param i32 i32)
    (local i32 i32 i32 i32 i32 i32)
    (local.set 3
      (call $malloc
        (i32.shl
  ...
  (global (;21;) i32 (i32.const 3698))
  (global (;22;) i32 (i32.const 3699))
  (global (;23;) i32 (i32.const 1024))
  (global (;24;) i32 (i32.const 5604))
  ...
  (export "STX" (global 21))
  (export "ETX" (global 22))
