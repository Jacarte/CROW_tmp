  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 32)))
    (i32.const 0))
  (func $sconcat (type 5) (param i32 i32) (result i32)
    (call $strcat
      (call $strcpy
        (call $malloc
          (i32.add
