(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 32)))
    (i32.const 0))
  (func $to_base (type 9) (param i64 i32) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 96)))
    (local.get 3))
  (func $from_base (type 5) (param i32 i32) (result i32)
    (local i32)
    (global.set 0
      (local.tee 2
        (i32.sub
  ...
  (export "to_base" (func $to_base))
  (export "from_base" (func $from_base))
