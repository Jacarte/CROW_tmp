(module
  ...
  (func $atof (type 23) (param i32) (result f64)
    (call $strtod
      (local.get 0)
      (i32.const 0)))
  (func $lineSlope (type 21) (param i32 i32) (result f64)
    (local f64 f64)
    (local.set 2
      (f64.const nan (;=nan;)))
    (block  ;; label = @1
      ...
      (local.set 2
        (f64.div
          ...
          (local.get 3))))
    (local.get 2))
  (func $extractPoint (type 10) (param i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
  ...
  (global (;22;) i32 (i32.const 5768))
  (global (;23;) i32 (i32.const 1024))
  (global (;24;) i32 (i32.const 71312))
  ...
  (export "lineSlope" (func $lineSlope))
  (export "extractPoint" (func $extractPoint))
