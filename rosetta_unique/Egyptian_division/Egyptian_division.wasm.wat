(module
  ...
  (func $go (type 16) (param i64 i64)
    ...
    (global.set 0
      (i32.add
        (local.get 2)
        (i32.const 48))))
  (func $egyptian_division (type 17) (param i64 i64 i32) (result i64)
  ...
  (table (;0;) 5 5 funcref)
  (memory (;0;) 2)
  (global (;0;) (mut i32) (i32.const 72080))
  ...
  (global (;22;) i32 (i32.const 6544))
  (global (;23;) i32 (i32.const 1024))
  (global (;24;) i32 (i32.const 72080))
  ...
  (export "egyptian_division" (func $egyptian_division))
  (export "go" (func $go))
