(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 48)))
    (i32.const 0))
  (func $make (type 14) (param i32 i32 i32)
    (i32.store offset=4
      (local.get 0)
      (local.get 2))
    (i32.store
  ...
  (func $print (type 2) (param i32)
    ...
    (global.set 0
      (i32.add
        (local.get 1)
        (i32.const 16))))
  (func $pow (type 14) (param i32 i32 i32)
    (local i32)
    (global.set 0
      (local.tee 3
        (i32.sub
  ...
  (func $add (type 14) (param i32 i32 i32)
    (call $make
      ...
      (i32.load offset=4
        (local.get 1))))
  (func $addi (type 14) (param i32 i32 i32)
    (call $make
      (local.get 0)
      (i32.add
        (i32.load
