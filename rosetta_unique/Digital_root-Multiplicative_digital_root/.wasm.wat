  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 304)))
    (i32.const 0))
  (func $_mdr (type 16) (param i32 i32 i64)
    (local i32 i64 i64)
    (local.set 3
      (i64.ne
        (local.get 2)
