(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (call $driver
      ...
      (i32.const -62))
    (i32.const 0))
  (func $driver (type 10) (param i32 i32)
    (local i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 2)
        (i32.const 96))))
  (func $encodeNegativeBase (type 14) (param i32 i32 i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
          ...
          (i32.lt_u
            ...
            (local.tee 0
              (i32.add
                (local.get 0)
                (i32.const -1))))))))
  (func $decodeNegativeBase (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
  ...
  (global (;21;) i32 (i32.const 3600))
  (global (;22;) i32 (i32.const 3664))
  ...
  (export "encodeNegativeBase" (func $encodeNegativeBase))
  (export "decodeNegativeBase" (func $decodeNegativeBase))
  (export "driver" (func $driver))
  (export "DIGITS" (global 21))
  (export "DIGITS_LEN" (global 22))
