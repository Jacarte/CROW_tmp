(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 96)))
    (i32.const 0))
  (func $kolakoski (type 11) (param i32 i32 i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    (local.set 4
      (i32.const 0))
    (local.set 5
          ...
          (i32.ne
            (local.tee 4
              (i32.add
                ...
                (i32.const 1)))
            (local.get 3))))))
  (func $print_array (type 10) (param i32 i32)
    (local i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 2)
        (i32.const 16))))
  (func $possible_kolakoski (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32)
    (local.set 2
      (i32.load
        (local.get 0)))
    ...
    (call $free
      (local.get 4))
    (local.get 1))
  (func $next_in_cycle (type 0) (param i32 i32 i32) (result i32)
    (i32.load
      (i32.add
        (local.get 0)
        (i32.shl
  ...
  (export "next_in_cycle" (func $next_in_cycle))
  (export "kolakoski" (func $kolakoski))
  (export "possible_kolakoski" (func $possible_kolakoski))
  (export "print_array" (func $print_array))
