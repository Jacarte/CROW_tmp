(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 96)))
    (i32.const 0))
  (func $stk_int_create (type 4) (param i32) (result i32)
    (local i32 i32)
    (local.set 1
      (i32.const 0))
    (block  ;; label = @1
      ...
      (local.set 1
        (local.get 2)))
    (local.get 1))
  (func $stk_int_push (type 5) (param i32 i32) (result i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.lt_u
    ...
    (i32.store
      ...
      (local.get 1))
    (local.get 3))
  (func $stk_int_pop (type 4) (param i32) (result i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
    ...
    (call $abort)
    (unreachable))
  (func $stk_int_delete (type 2) (param i32)
    (call $free
      (i32.load
        (local.get 0)))
    (call $free
  ...
  (export "stk_int_create" (func $stk_int_create))
  (export "stk_int_push" (func $stk_int_push))
  (export "stk_int_pop" (func $stk_int_pop))
  (export "stk_int_delete" (func $stk_int_delete))
