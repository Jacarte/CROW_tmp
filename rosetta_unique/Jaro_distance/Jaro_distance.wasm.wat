  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 48)))
    (i32.const 0))
  (func $jaro (type 16) (param i32 i32) (result f64)
    (local i32 i32 i32 i32 i32 f64 i32 i32 i32 i32 i32 i32 i32 f64)
    (local.set 2
      (call $strlen
        (local.get 0)))
    (local.set 3
