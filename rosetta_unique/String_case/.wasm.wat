(module
  ...
  (func $frexp (type 15) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $toupper (type 5) (param i32) (result i32)
    (select
      (i32.and
        (local.get 0)
        (i32.const 95))
      ...
      (i32.lt_u
        (i32.add
          ...
          (i32.const -97))
        (i32.const 26))))
  (func $__toupper_l (type 3) (param i32 i32) (result i32)
    (select
      (i32.and
        (local.get 0)
        (i32.const 95))
    ...
    (select
      ...
      (i32.lt_u
        (i32.add
          ...
          (i32.const -65))
        (i32.const 26))))
  (func $str_toupper (type 2) (param i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
  ...
  (export "__toupper_l" (func $__toupper_l))
  (export "toupper_l" (func $__toupper_l))
  (export "str_toupper" (func $str_toupper))
