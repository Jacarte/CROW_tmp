(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 144)))
    (i32.const 0))
  (func $intRangeList (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (local.get 3))
  (func $listAppend (type 0) (param i32 i32 i32) (result i32)
    (local i32)
    (loop  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
    ...
    (i32.store
      ...
      (call $listNew
        ...
        (local.get 2)))
    (local.get 3))
  (func $listNew (type 5) (param i32 i32) (result i32)
    (local i32)
    (i32.store
      (local.tee 2
        (call $malloc
  ...
  (global (;21;) i32 (i32.const 5420))
  (global (;22;) i32 (i32.const 3772))
  (global (;23;) i32 (i32.const 5416))
  (global (;24;) i32 (i32.const 1024))
  (global (;25;) i32 (i32.const 5432))
  (global (;26;) i32 (i32.const 1024))
  (global (;27;) i32 (i32.const 70976))
  ...
  (export "listAppend" (func $listAppend))
  (export "intRangeList" (func $intRangeList))
  (export "SEQ_base" (global 21))
  (export "SEQ_var" (global 22))
  (export "FE_var" (global 23))
