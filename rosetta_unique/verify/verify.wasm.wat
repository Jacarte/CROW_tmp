(module
  ...
  (func $frexp (type 15) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $crypto_verify_16_bytes (type 11) (result i32)
    (i32.const 16))
  (func $crypto_verify_32_bytes (type 11) (result i32)
    (i32.const 32))
  (func $crypto_verify_64_bytes (type 11) (result i32)
    (i32.const 64))
  (func $crypto_verify_16 (type 3) (param i32 i32) (result i32)
    (local i32 i32)
    (i32.store offset=12
      (local.tee 2
        (i32.sub
    ...
    (i32.add
      (i32.and
        ...
        (i32.const 1))
      (i32.const -1)))
  (func $crypto_verify_32 (type 3) (param i32 i32) (result i32)
    (local i32 i32)
    (i32.store offset=12
      (local.tee 2
        (i32.sub
    ...
    (i32.add
      (i32.and
        ...
        (i32.const 1))
      (i32.const -1)))
  (func $crypto_verify_64 (type 3) (param i32 i32) (result i32)
    (local i32 i32)
    (i32.store offset=12
      (local.tee 2
        (i32.sub
  ...
  (export "crypto_verify_16_bytes" (func $crypto_verify_16_bytes))
  (export "crypto_verify_32_bytes" (func $crypto_verify_32_bytes))
  (export "crypto_verify_64_bytes" (func $crypto_verify_64_bytes))
  (export "crypto_verify_16" (func $crypto_verify_16))
  (export "crypto_verify_32" (func $crypto_verify_32))
  (export "crypto_verify_64" (func $crypto_verify_64))
