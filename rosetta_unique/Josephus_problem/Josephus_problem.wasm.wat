(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 64)))
    (i32.const 0))
  (func $jos (type 0) (param i32 i32 i32) (result i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.lt_s
    ...
    (loop  ;; label = @2
      ...
      (br_if 0 (;@2;)
        (i32.ne
          ...
          (local.get 2))))
    (local.get 3))
  (func $jos_large (type 16) (param i64 i64 i64) (result i64)
  ...
  (export "jos" (func $jos))
  (export "jos_large" (func $jos_large))
