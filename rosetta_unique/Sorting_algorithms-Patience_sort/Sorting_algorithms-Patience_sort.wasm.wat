  ...
  (func $atoi (type 5) (param i32) (result i32)
    ...
    (select
      ...
      (i32.sub
        ...
        (local.get 2))
      (local.get 4)))
  (func $patienceSort (type 3) (param i32 i32) (result i32)
