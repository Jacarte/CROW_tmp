  ...
  (func $lambda (type 2) (param i32) (result i32)
    (i32.rem_s
      (i32.add
        ...
        (i32.const 1))
      (i32.const 255)))
  (func $brent (type 14) (param i32 i32 i32)
    (local i32 i32 i32 i32)
    (local.set 3
      (i32.const 1))
    (block  ;; label = @1
