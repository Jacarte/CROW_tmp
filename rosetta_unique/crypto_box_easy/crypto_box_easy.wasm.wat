(module
  ...
  (type (;7;) (func (param i32 i32 i32 i64 i32 i32) (result i32)))
  ...
  (type (;17;) (func (param i32 i32 i32 i64 i32 i32 i32) (result i32)))
  (type (;18;) (func (param i32 i32 i64 i32 i32) (result i32)))
  (type (;19;) (func (param i32 i32 i64 i32 i32 i32) (result i32)))
  ...
  (import "env" "crypto_secretbox_detached" (func $crypto_secretbox_detached (type 7)))
  (import "env" "crypto_box_beforenm" (func $crypto_box_beforenm (type 0)))
  (import "env" "sodium_memzero" (func $sodium_memzero (type 8)))
  (import "env" "sodium_misuse" (func $sodium_misuse (type 9)))
  (import "env" "crypto_secretbox_open_detached" (func $crypto_secretbox_open_detached (type 7)))
  ...
  (func $frexp (type 16) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $crypto_box_detached_afternm (type 7) (param i32 i32 i32 i64 i32 i32) (result i32)
    (call $crypto_secretbox_detached
      (local.get 0)
      (local.get 1)
      (local.get 2)
      (local.get 3)
      (local.get 4)
      (local.get 5)))
  (func $crypto_box_detached (type 17) (param i32 i32 i32 i64 i32 i32 i32) (result i32)
    (local i32 i32)
    (global.set 0
      (local.tee 7
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 32)))
    (local.get 8))
  (func $crypto_box_easy_afternm (type 18) (param i32 i32 i64 i32 i32) (result i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
          (i32.xor
    ...
    (call $crypto_secretbox_detached
      ...
      (local.get 3)
      (local.get 4)))
  (func $crypto_box_easy (type 19) (param i32 i32 i64 i32 i32 i32) (result i32)
    (local i32 i32)
    (global.set 0
      (local.tee 6
        (i32.sub
    ...
    (call $sodium_misuse)
    (unreachable))
  (func $crypto_box_open_detached_afternm (type 7) (param i32 i32 i32 i64 i32 i32) (result i32)
    (call $crypto_secretbox_open_detached
      (local.get 0)
      (local.get 1)
      (local.get 2)
      (local.get 3)
      (local.get 4)
      (local.get 5)))
  (func $crypto_box_open_detached (type 17) (param i32 i32 i32 i64 i32 i32 i32) (result i32)
    (local i32 i32)
    (global.set 0
      (local.tee 7
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 32)))
    (local.get 8))
  (func $crypto_box_open_easy_afternm (type 18) (param i32 i32 i64 i32 i32) (result i32)
    (local i32)
    (local.set 5
      (i32.const -1))
    (block  ;; label = @1
      ...
      (local.set 5
        (call $crypto_secretbox_open_detached
          ...
          (local.get 4))))
    (local.get 5))
  (func $crypto_box_open_easy (type 19) (param i32 i32 i64 i32 i32 i32) (result i32)
    (local i32 i32)
    (global.set 0
      (local.tee 6
        (i32.sub
  ...
  (export "crypto_box_detached_afternm" (func $crypto_box_detached_afternm))
  (export "crypto_box_detached" (func $crypto_box_detached))
  (export "crypto_box_easy_afternm" (func $crypto_box_easy_afternm))
  (export "crypto_box_easy" (func $crypto_box_easy))
  (export "crypto_box_open_detached_afternm" (func $crypto_box_open_detached_afternm))
  (export "crypto_box_open_detached" (func $crypto_box_open_detached))
  (export "crypto_box_open_easy_afternm" (func $crypto_box_open_easy_afternm))
  (export "crypto_box_open_easy" (func $crypto_box_open_easy))
