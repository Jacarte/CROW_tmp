(module
  ...
  (type (;7;) (func (param i32 i32 i32 i32 i32 i32 i32 i32 i32) (result i32)))
  ...
  (type (;18;) (func (param i32 i64 i32 i64 i32 i64 i32 i32) (result i32)))
  ...
  (import "env" "argon2i_hash_raw" (func $argon2i_hash_raw (type 7)))
  (import "env" "randombytes_buf" (func $randombytes_buf (type 8)))
  (import "env" "argon2i_hash_encoded" (func $argon2i_hash_encoded (type 9)))
  (import "env" "argon2i_verify" (func $argon2i_verify (type 0)))
  (import "env" "argon2_decode_string" (func $argon2_decode_string (type 0)))
  (func $__wasm_call_ctors (type 10))
  (func $polybench_flush_cache (type 10)
    ...
    (global.set 0
      (local.get 38))
    (return))
  (func $polybench_prepare_instruments (type 10)
    (call $polybench_flush_cache)
    (return))
  (func $polybench_timer_start (type 10)
    (local f64 i32)
    ...
    (f64.store offset=3792
      ...
      (local.get 0))
    (return))
  (func $rtclock (type 11) (result f64)
    (local i32 f64)
    (local.set 0
      (i32.const 0))
    (local.set 1
    ...
    (return
      (local.get 1)))
  (func $polybench_timer_stop (type 10)
    (local f64 i32)
    (local.set 0
      (call $rtclock))
    (local.set 1
    ...
    (f64.store offset=3800
      ...
      (local.get 0))
    (return))
  (func $polybench_timer_print (type 10)
  ...
  (func $polybench_free_data (type 2) (param i32)
    ...
    (global.set 0
      (local.get 6))
    (return))
  (func $polybench_alloc_data (type 12) (param i64 i32) (result i32)
  ...
  (func $exit (type 2) (param i32)
    ...
    (call $_Exit
      (local.get 0))
    (unreachable))
  (func $__assert_fail (type 14) (param i32 i32 i32 i32)
    (local i32)
    (global.set 0
      (local.tee 4
        (i32.sub
    ...
    (i32.store offset=16
      ...
      (i32.add
        ...
        (i32.load offset=44
          (local.get 0))))
    (i32.const 0))
  (func $__towrite_needs_stdio_exit (type 10)
    (call $__stdio_exit))
  ...
  (func $frexp (type 17) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $crypto_pwhash_argon2i_alg_argon2i13 (type 13) (result i32)
    (i32.const 1))
  (func $crypto_pwhash_argon2i_bytes_min (type 13) (result i32)
    (i32.const 16))
  (func $crypto_pwhash_argon2i_bytes_max (type 13) (result i32)
    (i32.const -1))
  (func $crypto_pwhash_argon2i_passwd_min (type 13) (result i32)
    (i32.const 0))
  (func $crypto_pwhash_argon2i_passwd_max (type 13) (result i32)
    (i32.const -1))
  (func $crypto_pwhash_argon2i_saltbytes (type 13) (result i32)
    (i32.const 16))
  (func $crypto_pwhash_argon2i_strbytes (type 13) (result i32)
    (i32.const 128))
  (func $crypto_pwhash_argon2i_strprefix (type 13) (result i32)
    (i32.const 3520))
  (func $crypto_pwhash_argon2i_opslimit_min (type 13) (result i32)
    (i32.const 3))
  (func $crypto_pwhash_argon2i_opslimit_max (type 13) (result i32)
    (i32.const -1))
  (func $crypto_pwhash_argon2i_memlimit_min (type 13) (result i32)
    (i32.const 8192))
  (func $crypto_pwhash_argon2i_memlimit_max (type 13) (result i32)
    (i32.const -2147483648))
  (func $crypto_pwhash_argon2i_opslimit_interactive (type 13) (result i32)
    (i32.const 4))
  (func $crypto_pwhash_argon2i_memlimit_interactive (type 13) (result i32)
    (i32.const 33554432))
  (func $crypto_pwhash_argon2i_opslimit_moderate (type 13) (result i32)
    (i32.const 6))
  (func $crypto_pwhash_argon2i_memlimit_moderate (type 13) (result i32)
    (i32.const 134217728))
  (func $crypto_pwhash_argon2i_opslimit_sensitive (type 13) (result i32)
    (i32.const 8))
  (func $crypto_pwhash_argon2i_memlimit_sensitive (type 13) (result i32)
    (i32.const 536870912))
  (func $crypto_pwhash_argon2i (type 18) (param i32 i64 i32 i64 i32 i64 i32 i32) (result i32)
    (local i32)
    (local.set 0
      (call $memset
        (local.get 0)
    ...
    (i32.store offset=4324
      ...
      (i32.const 28))
    (i32.const -1))
  (func $crypto_pwhash_argon2i_str (type 19) (param i32 i32 i64 i64 i32) (result i32)
    (local i32)
    (global.set 0
      (local.tee 5
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (local.get 4))
  (func $crypto_pwhash_argon2i_str_verify (type 20) (param i32 i32 i64) (result i32)
    (block  ;; label = @1
      (block  ;; label = @2
        (block  ;; label = @3
          (br_if 0 (;@3;)
      ...
      (local.set 0
        (i32.const -1)))
    (local.get 0))
  (func $crypto_pwhash_argon2i_str_needs_rehash (type 21) (param i32 i64 i32) (result i32)
    (call $_needs_rehash
      (local.get 0)
      (local.get 1)
      (local.get 2)
      (i32.const 1)))
  (func $_needs_rehash (type 4) (param i32 i64 i32 i32) (result i32)
    (local i32 i32 i32 i32)
    (global.set 0
      (local.tee 4
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 64)))
    (local.get 5))
  (func $crypto_pwhash_argon2id_str_needs_rehash (type 21) (param i32 i64 i32) (result i32)
    (call $_needs_rehash
      (local.get 0)
      (local.get 1)
      (local.get 2)
  ...
  (export "crypto_pwhash_argon2i_alg_argon2i13" (func $crypto_pwhash_argon2i_alg_argon2i13))
  (export "crypto_pwhash_argon2i_bytes_min" (func $crypto_pwhash_argon2i_bytes_min))
  (export "crypto_pwhash_argon2i_bytes_max" (func $crypto_pwhash_argon2i_bytes_max))
  (export "crypto_pwhash_argon2i_passwd_min" (func $crypto_pwhash_argon2i_passwd_min))
  (export "crypto_pwhash_argon2i_passwd_max" (func $crypto_pwhash_argon2i_passwd_max))
  (export "crypto_pwhash_argon2i_saltbytes" (func $crypto_pwhash_argon2i_saltbytes))
  (export "crypto_pwhash_argon2i_strbytes" (func $crypto_pwhash_argon2i_strbytes))
  (export "crypto_pwhash_argon2i_strprefix" (func $crypto_pwhash_argon2i_strprefix))
  (export "crypto_pwhash_argon2i_opslimit_min" (func $crypto_pwhash_argon2i_opslimit_min))
  (export "crypto_pwhash_argon2i_opslimit_max" (func $crypto_pwhash_argon2i_opslimit_max))
  (export "crypto_pwhash_argon2i_memlimit_min" (func $crypto_pwhash_argon2i_memlimit_min))
  (export "crypto_pwhash_argon2i_memlimit_max" (func $crypto_pwhash_argon2i_memlimit_max))
  (export "crypto_pwhash_argon2i_opslimit_interactive" (func $crypto_pwhash_argon2i_opslimit_interactive))
  (export "crypto_pwhash_argon2i_memlimit_interactive" (func $crypto_pwhash_argon2i_memlimit_interactive))
  (export "crypto_pwhash_argon2i_opslimit_moderate" (func $crypto_pwhash_argon2i_opslimit_moderate))
  (export "crypto_pwhash_argon2i_memlimit_moderate" (func $crypto_pwhash_argon2i_memlimit_moderate))
  (export "crypto_pwhash_argon2i_opslimit_sensitive" (func $crypto_pwhash_argon2i_opslimit_sensitive))
  (export "crypto_pwhash_argon2i_memlimit_sensitive" (func $crypto_pwhash_argon2i_memlimit_sensitive))
  (export "crypto_pwhash_argon2i" (func $crypto_pwhash_argon2i))
  (export "crypto_pwhash_argon2i_str" (func $crypto_pwhash_argon2i_str))
  (export "crypto_pwhash_argon2i_str_verify" (func $crypto_pwhash_argon2i_str_verify))
  (export "crypto_pwhash_argon2i_str_needs_rehash" (func $crypto_pwhash_argon2i_str_needs_rehash))
  (export "crypto_pwhash_argon2id_str_needs_rehash" (func $crypto_pwhash_argon2id_str_needs_rehash))
