(module
  ...
  (func $putchar (type 5) (param i32) (result i32)
    ...
    (call $__overflow
      (i32.const 3568)
      (local.get 1)))
  (func $xferFactors (type 14) (param i32 i32 i32)
    (local i32 i32 i32)
    (local.set 5
      (select
        (select
    ...
    (i32.store16 offset=4
      (local.get 0)
      (local.get 5)))
  (func $factor (type 3) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
  ...
  (export "xferFactors" (func $xferFactors))
  (export "factor" (func $factor))
