  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $bin (type 4) (param i32) (result i32)
        ...
        (f64.add
          (f64.div
            (call $log10
              (f64.convert_i32_u
                (local.get 0)))
            (f64.const 0x1.34413509f79ffp-2 (;=0.30103;)))
          (f64.const 0x1p+0 (;=1;)))))
    (block  ;; label = @3
      (block  ;; label = @4
        (br_if 0 (;@4;)
