(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 256)))
    (i32.const 0))
  (func $makeZeckendorf (type 10) (param i32 i32)
    (local i32 i32 i32)
    (i64.store align=4
      (local.get 0)
      (i64.const 0))
    ...
    (block  ;; label = @1
      ...
      (i32.store
        (local.get 0)
        (local.get 3))))
  (func $addAssign (type 10) (param i32 i32)
    (local i32 i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
        ...
        (br_if 0 (;@3;)
          (i32.and
            (i32.lt_s
              ...
              (local.get 3))
            (i32.const 1))))))
  (func $printZeckendorf (type 2) (param i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
        ...
        (br_if 0 (;@3;)
          (i32.and
            (i32.ge_s
              ...
              (i32.const 0))
            (i32.const 1))))))
  (func $subAssign (type 10) (param i32 i32)
    (local i32 i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
      ...
      (block  ;; label = @6
        ...
        (i32.store offset=4
          ...
          (i32.add
            ...
            (i32.const -1)))
        (br 1 (;@5;)))))
  (func $mulAssign (type 10) (param i32 i32)
    (local i32)
    (global.set 0
      (local.tee 2
        (i32.sub
  ...
  (func $c (type 10) (param i32 i32)
    ...
    (call $increment
      (local.get 0)))
  (func $inv (type 4) (param i32) (result i32)
    (i32.xor
      (local.get 0)
      (i32.const -1)))
  ...
  (export "c" (func $c))
  (export "makeZeckendorf" (func $makeZeckendorf))
  (export "addAssign" (func $addAssign))
  (export "subAssign" (func $subAssign))
  (export "mulAssign" (func $mulAssign))
  (export "printZeckendorf" (func $printZeckendorf))
