(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 1040)))
    (i32.const 0))
  (func $longmulti (type 14) (param i32 i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    (block  ;; label = @1
      (block  ;; label = @2
        (br_if 0 (;@2;)
  ...
  (export "longmulti" (func $longmulti))
