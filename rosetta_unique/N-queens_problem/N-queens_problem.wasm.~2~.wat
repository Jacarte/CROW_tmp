(module
  ...
  (func $atoi (type 5) (param i32) (result i32)
    ...
    (select
      ...
      (i32.sub
        ...
        (local.get 2))
      (local.get 4)))
  (func $solve (type 12) (param i32 i32 i32 i32)
    (local i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
  ...
  (global (;24;) i32 (i32.const 5428))
  (global (;25;) i32 (i32.const 1024))
  (global (;26;) i32 (i32.const 5432))
  (global (;27;) i32 (i32.const 1024))
  (global (;28;) i32 (i32.const 70976))
  ...
  (export "count" (global 21))
  (export "full" (global 22))
  (export "qs" (global 23))
  (export "nn" (global 24))
