(module
  ...
  (func $easter_related_print (type 2) (param i32)
    ...
    (global.set 0
      (i32.add
        (local.get 1)
        (i32.const 144))))
  (func $easter_related_init (type 10) (param i32 i32)
    (local i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 2)
        (i32.const 48))))
  (func $easter (type 10) (param i32 i32)
    (local i32 i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 2)
        (i32.const 16))))
  (func $plusab (type 14) (param i32 i32 i32)
    (local i32 i32 i32 i32)
    (global.set 0
      (local.tee 3
        (i32.sub
    ...
    (select
      ...
      (i32.and
        (i32.eq
          ...
          (i32.const 28))
        (i32.const 1))))
  (func $month_days (type 5) (param i32 i32) (result i32)
    (local i32)
    (i32.store
      (i32.add
        (local.tee 2
  ...
  (table (;0;) 5 5 funcref)
  (memory (;0;) 2)
  (global (;0;) (mut i32) (i32.const 71440))
  ...
  (global (;9;) i32 (i32.const 3920))
  (global (;10;) i32 (i32.const 4812))
  (global (;11;) i32 (i32.const 4816))
  (global (;12;) i32 (i32.const 4820))
  (global (;13;) i32 (i32.const 4848))
  (global (;14;) i32 (i32.const 4812))
  (global (;15;) i32 (i32.const 4816))
  (global (;16;) i32 (i32.const 4040))
  (global (;17;) i32 (i32.const 4152))
  (global (;18;) i32 (i32.const 4032))
  (global (;19;) i32 (i32.const 4860))
  (global (;20;) i32 (i32.const 3516))
  (global (;21;) i32 (i32.const 4192))
  (global (;22;) i32 (i32.const 4160))
  (global (;23;) i32 (i32.const 4244))
  (global (;24;) i32 (i32.const 4248))
  (global (;25;) i32 (i32.const 1024))
  (global (;26;) i32 (i32.const 5896))
  (global (;27;) i32 (i32.const 1024))
  (global (;28;) i32 (i32.const 71440))
  ...
  (export "mon_fmt" (global 21))
  (export "week_day_fmt" (global 22))
  (export "year_months" (global 23))
  (export "week_days" (global 24))
