(module
  ...
  (type (;16;) (func (param i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)))
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 80)))
    (i32.const 0))
  (func $fourbitsadder (type 16) (param i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    (local i32)
    (global.set 0
      (local.tee 13
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 13)
        (i32.const 16))))
  (func $fulladder (type 17) (param i32 i32 i32 i32 i32)
    (local i32)
    (global.set 0
      (local.tee 5
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 5)
        (i32.const 16))))
  (func $halfadder (type 11) (param i32 i32 i32 i32)
    (local i32 i32)
    (i32.store8
      (local.get 2)
      (i32.and
  ...
  (export "halfadder" (func $halfadder))
  (export "fulladder" (func $fulladder))
  (export "fourbitsadder" (func $fourbitsadder))
