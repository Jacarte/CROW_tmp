  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 96)))
    (i32.const 0))
  (func $showCake (type 2) (param i32)
    (local i32)
    (global.set 0
      (local.tee 1
        (i32.sub
