  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 80)))
    (i32.const 0))
  (func $x (type 16) (param f64) (result f64)
    (f64.store offset=3784
      ...
      (local.tee 0
        (f64.add
          ...
          (local.get 0))))
    (local.get 0))
  (func $y (type 4) (param i32) (result i32)
    (i32.store offset=3776
      ...
      (local.tee 0
        (i32.add
          ...
          (local.get 0))))
    (local.get 0))
  (func $z (type 4) (param i32) (result i32)
