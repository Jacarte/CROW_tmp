(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (call $string_test
      (i32.const 3586))
    (i32.const 0))
  (func $string_test (type 2) (param i32)
    (local i32)
    (global.set 0
      (local.tee 1
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 1)
        (i32.const 32))))
  (func $incr (type 4) (param i32) (result i32)
  ...
  (export "string_test" (func $string_test))
