(module
  ...
  (import "env" "crypto_box_keypair" (func $crypto_box_keypair (type 3)))
  (import "env" "crypto_box_easy" (func $crypto_box_easy (type 7)))
  (import "env" "sodium_memzero" (func $sodium_memzero (type 8)))
  (import "env" "crypto_box_open_easy" (func $crypto_box_open_easy (type 7)))
  ...
  (func $frexp (type 17) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $crypto_box_seal (type 18) (param i32 i32 i64 i32) (result i32)
    (local i32 i32 i32)
    (local.set 5
      (local.tee 4
        (global.get 0)))
    ...
    (global.set 0
      (local.get 5))
    (local.get 6))
  (func $crypto_box_seal_open (type 19) (param i32 i32 i64 i32 i32) (result i32)
    (local i32 i32 i32)
    (local.set 6
      (local.tee 5
        (global.get 0)))
    ...
    (global.set 0
      (local.get 6))
    (local.get 7))
  (func $crypto_box_sealbytes (type 13) (result i32)
    (i32.const 48))
  (table (;0;) 5 5 funcref)
  (memory (;0;) 2)
  ...
  (export "crypto_box_seal" (func $crypto_box_seal))
  (export "crypto_box_seal_open" (func $crypto_box_seal_open))
  (export "crypto_box_sealbytes" (func $crypto_box_sealbytes))
