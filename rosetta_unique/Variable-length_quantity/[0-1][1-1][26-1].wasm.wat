(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 128)))
    (i32.const 0))
  (func $to_seq (type 16) (param i64 i32)
    ...
    (i32.store8
      ...
      (i32.xor
        (i32.load8_u
          (local.get 5))
        (i32.const 128))))
  (func $from_seq (type 17) (param i32) (result i64)
    (local i64 i32)
    (local.set 1
      (i64.const 0))
    (loop  ;; label = @1
  ...
  (export "to_seq" (func $to_seq))
  (export "from_seq" (func $from_seq))
