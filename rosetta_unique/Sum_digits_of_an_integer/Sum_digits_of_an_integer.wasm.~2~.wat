  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 32)))
    (i32.const 0))
  (func $SumDigits (type 9) (param i64 i32) (result i32)
    (local i64 i64 i64)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
