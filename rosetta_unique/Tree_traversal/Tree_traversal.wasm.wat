(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (call $destroy_tree
      (local.get 0))
    (i32.const 0))
  (func $tree (type 0) (param i32 i32 i32) (result i32)
    (local i32)
    (i32.store
      (local.tee 3
        (call $malloc
  ...
  (func $print (type 2) (param i32)
    ...
    (global.set 0
      (i32.add
        (local.get 1)
        (i32.const 16))))
  (func $preorder (type 10) (param i32 i32)
    (local i32)
    ...
    (block  ;; label = @2
      ...
      (call $preorder
        (local.get 0)
        (local.get 1))))
  (func $inorder (type 10) (param i32 i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
    ...
    (block  ;; label = @2
      ...
      (call $inorder
        (local.get 0)
        (local.get 1))))
  (func $postorder (type 10) (param i32 i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
    ...
    (call_indirect (type 2)
      (i32.load
        (local.get 0))
      (local.get 1)))
  (func $levelorder (type 10) (param i32 i32)
    (local i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 2)
        (i32.const 16))))
  (func $destroy_tree (type 2) (param i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
    ...
    (call $free
      (local.get 0)))
  (func $enqueue (type 10) (param i32 i32)
    (local i32)
    (i32.store offset=4
      (local.tee 2
        (call $malloc
    ...
    (i32.store offset=4
      (local.get 0)
      (local.get 2)))
  (func $queue_empty (type 4) (param i32) (result i32)
    (i32.and
      (i32.xor
        (i32.ne
          (i32.load
        ...
        (i32.const 1))
      (i32.const 1)))
  (func $dequeue (type 4) (param i32) (result i32)
    (local i32 i32 i32)
    (local.set 2
      (i32.load offset=4
        (local.tee 1
  ...
  (export "destroy_tree" (func $destroy_tree))
  (export "preorder" (func $preorder))
  (export "inorder" (func $inorder))
  (export "postorder" (func $postorder))
  (export "enqueue" (func $enqueue))
  (export "dequeue" (func $dequeue))
  (export "queue_empty" (func $queue_empty))
  (export "levelorder" (func $levelorder))
