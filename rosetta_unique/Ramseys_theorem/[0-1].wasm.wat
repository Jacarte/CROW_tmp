(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $find_group (type 6) (param i32 i32 i32 i32) (result i32)
    (local i32 i32 i32 i32)
    (global.set 0
      (local.tee 4
        (i32.sub
  ...
  (global (;21;) i32 (i32.const 6656))
  (global (;22;) i32 (i32.const 5488))
  (global (;23;) i32 (i32.const 1024))
  (global (;24;) i32 (i32.const 6672))
