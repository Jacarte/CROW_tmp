(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (i64.store
      (local.get 3)
      (i64.const 4630685579355357184))
    (i64.store
      (local.get 2)
      (i64.const 4630967054332067840))
    (i64.store
      (local.get 1)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 352)))
    (i32.const 0))
  (func $fivenum (type 0) (param i32 i32 i32) (result i32)
    ...
    (f64.store offset=24
      ...
      (call $median
        ...
        (local.get 4)))
    (i32.const 0))
  (func $show (type 2) (param i32 i32) (result i32)
    (local i32)
    (global.set 0
      (local.tee 2
        (i32.sub
  ...
  (func $compare (type 2) (param i32 i32) (result i32)
    ...
    (block  ;; label = @1
      ...
      (local.set 2
        (i32.const 0)))
    (local.get 2))
  (func $median (type 17) (param i32 i32 i32) (result f64)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
          (i32.and
  ...
  (export "median" (func $median))
  (export "compare" (func $compare))
  (export "fivenum" (func $fivenum))
