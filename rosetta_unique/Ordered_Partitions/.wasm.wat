(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (call $gen_bits
      ...
      (i32.const 0))
    (i32.const 0))
  (func $gen_bits (type 16) (param i32 i32 i32 i32 i32)
    (local i32)
    (block  ;; label = @1
      (block  ;; label = @2
        (br_if 0 (;@2;)
      ...
      (loop  ;; label = @6
        ...
        (br_if 0 (;@6;)
          (local.get 0)))))
  (func $show_part (type 2) (param i32)
    (local i32 i32 i32)
    (global.set 0
      (local.tee 1
        (i32.sub
  ...
  (global (;21;) i32 (i32.const 3772))
  (global (;22;) i32 (i32.const 5444))
  (global (;23;) i32 (i32.const 1024))
  (global (;24;) i32 (i32.const 5456))
  ...
  (export "show_part" (func $show_part))
  (export "gen_bits" (func $gen_bits))
  (export "parts" (global 21))
  (export "bits" (global 22))
