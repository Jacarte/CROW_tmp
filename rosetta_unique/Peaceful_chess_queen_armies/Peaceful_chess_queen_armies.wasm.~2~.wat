(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (call $test
      ...
      (i32.const 7))
    (i32.const 0))
  (func $test (type 10) (param i32 i32)
    (local i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 2)
        (i32.const 48))))
  (func $makeList (type 2) (param i32)
    (i32.store
      (local.get 0)
      (i32.const 0))
    (i32.store offset=4
    ...
    (i32.store offset=8
      (local.get 0)
      (i32.const 0)))
  (func $place (type 6) (param i32 i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 4
        (i32.sub
    ...
    (call $exit
      (i32.const 1))
    (unreachable))
  (func $printBoard (type 14) (param i32 i32 i32)
    (local i32 i32)
    (block  ;; label = @1
      (block  ;; label = @2
        (br_if 0 (;@2;)
    ...
    (call $exit
      (i32.const 1))
    (unreachable))
  (func $releaseList (type 2) (param i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
          (i32.eqz
      ...
      (i32.store offset=4
        (local.get 0)
        (i32.const 0))))
  (func $isAttacking (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32)
    (local.set 2
      (i32.const 1))
    (block  ;; label = @1
    ...
    (i32.and
      (local.get 2)
      (i32.const 1)))
  (func $addNode (type 10) (param i32 i32)
    (local i32)
    (block  ;; label = @1
      (block  ;; label = @2
        (br_if 0 (;@2;)
    ...
    (call $exit
      (i32.const 1))
    (unreachable))
  (func $removeAt (type 10) (param i32 i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
      ...
      (i32.store offset=8
        ...
        (i32.add
          (i32.load offset=8
            (local.get 0))
          (i32.const -1)))))
  (func $releaseNode (type 2) (param i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
          (i32.eqz
  ...
  (export "releaseNode" (func $releaseNode))
  (export "makeList" (func $makeList))
  (export "releaseList" (func $releaseList))
  (export "addNode" (func $addNode))
  (export "removeAt" (func $removeAt))
  (export "isAttacking" (func $isAttacking))
  (export "place" (func $place))
  (export "printBoard" (func $printBoard))
