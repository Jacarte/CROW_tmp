(module
  ...
  (type (;16;) (func (param f64 i64 i32 i32)))
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 112)))
    (i32.const 0))
  (func $rat_approx (type 16) (param f64 i64 i32 i32)
    (local i64 f64 i64 i64 i32 i64 i64 i64 i64 i64 i64 i32)
    (local.set 4
      (i64.const 1))
    (block  ;; label = @1
      (br_if 0 (;@1;)
  ...
  (export "rat_approx" (func $rat_approx))
