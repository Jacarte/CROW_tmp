(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (call $table
      ...
      (i32.const 3732))
    (i32.const 0))
  (func $table (type 10) (param i32 i32)
    (local i32 i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
