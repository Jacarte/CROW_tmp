(module
  ...
  (func $__original_main (type 12) (result i32)
    (local i32 i32 i64 i32 i64 i32 i64 i32 i64 i64)
    (global.set 0
      (local.tee 0
        (i32.sub
          (global.get 0)
