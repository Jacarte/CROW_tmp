(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $rtrim (type 4) (param i32) (result i32)
    (local i32 i32)
    (local.set 0
      (i32.add
        (local.get 0)
    ...
    (call $strdup
      (local.get 0)))
  (func $ltrim (type 4) (param i32) (result i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
      ...
      (loop  ;; label = @2
        ...
        (br 0 (;@5;))))
    (local.get 1))
  (func $trim (type 4) (param i32) (result i32)
    (local i32)
    (local.set 1
      (call $ltrim
        (local.tee 0
  ...
  (global (;21;) i32 (i32.const 3804))
  (global (;22;) i32 (i32.const 1024))
  (global (;23;) i32 (i32.const 5460))
  ...
  (export "rtrim" (func $rtrim))
  (export "ltrim" (func $ltrim))
  (export "trim" (func $trim))
  (export "a" (global 21))
