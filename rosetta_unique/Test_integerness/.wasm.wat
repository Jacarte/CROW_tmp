(module
    ...
    (block  ;; label = @1
      ...
      (local.set 4
        (i64.ne
          ...
          (i64.const 0))))
    (local.get 4))
  (func $__getf2 (type 16) (param i64 i64 i64 i64) (result i32)
    (local i32 i64 i64)
    (local.set 4
      (i32.const -1))
    (block  ;; label = @1
      ...
      (local.set 4
        (i64.ne
          ...
          (i64.const 0))))
    (local.get 4))
  (func $__unordtf2 (type 16) (param i64 i64 i64 i64) (result i32)
    (i32.or
      (select
        (i64.ne
          (local.get 0)
  ...
  (func $__lshrti3 (type 17) (param i32 i64 i64 i32)
    ...
    (i64.store offset=8
      (local.get 0)
      (local.get 2)))
  (func $__addtf3 (type 18) (param i32 i64 i64 i64 i64)
    ...
    (global.set 0
      (i32.add
        (local.get 5)
        (i32.const 112))))
  (func $__multf3 (type 18) (param i32 i64 i64 i64 i64)
    ...
    (global.set 0
      (i32.add
        (local.get 5)
        (i32.const 96))))
  (func $rintl (type 19) (param i32 i64 i64)
    ...
    (global.set 0
      (i32.add
        (local.get 3)
        (i32.const 80))))
  (func $nearbyintl (type 19) (param i32 i64 i64)
    (local i32)
    (global.set 0
      (local.tee 3
        (i32.sub
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 1728)))
    (i32.const 0))
  (func $isint (type 4) (param i32) (result i32)
    (local i32 i64 i64)
    (global.set 0
      (local.tee 1
        (i32.sub
  ...
  (export "nearbyintl" (func $nearbyintl))
  (export "rintl" (func $rintl))
