(module
  ...
  (func $atoi (type 5) (param i32) (result i32)
    ...
    (select
      ...
      (i32.sub
        ...
        (local.get 2))
      (local.get 4)))
  (func $addAndOrderList (type 10) (param i32 i32)
    (local i32 i32 i32 i32 i32 f64 f64 i32)
    (local.set 2
      (i32.load
        (local.get 0)))
    (local.set 3
    ...
    (i64.store
      ...
      (i64.load
        (i32.add
          (local.get 1)
          (i32.const 16)))))
  (func $gcd (type 3) (param i32 i32) (result i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
          (local.get 1)))
      (local.set 0
        (call $gcd
          ...
          (i32.rem_s
            ...
            (local.get 1)))))
    (local.get 0))
  (func $calculateArea (type 2) (param i32)
          ...
          (f64.mul
            ...
            (f64.mul
              ...
              (f64.sub
                ...
                (f64.convert_i32_s
                  (local.get 2)))))))))
  (func $generateTriangleList (type 3) (param i32 i32) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 64)))
    (local.get 0))
  (func $printList (type 14) (param i32 i32 i32)
    (local i32 i32 f64 i32 i32 i64 i64 f64)
    (global.set 0
      (local.tee 3
        (i32.sub
          (global.get 0)
  ...
  (export "addAndOrderList" (func $addAndOrderList))
  (export "gcd" (func $gcd))
  (export "calculateArea" (func $calculateArea))
  (export "generateTriangleList" (func $generateTriangleList))
