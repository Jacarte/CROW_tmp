(module
  ...
  (func $__original_main (type 12) (result i32)
    (local i32 i32 i32 f64 i32 i32 i32 i32 f64 i32 f64)
    (global.set 0
      (local.tee 0
        (i32.sub
          (global.get 0)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 160)))
    (i32.const 0))
  (func $rand_idx (type 5) (param i32 i32) (result i32)
    (local i32 f64 i32)
    (local.set 2
      (i32.sub
        (local.get 1)
