  ...
  (func $solve (type 2) (param i32)
    ...
    (global.set 0
      (i32.add
        (local.get 1)
        (i32.const 336))))
  (func $trycell (type 5) (param i32 i32) (result i32)
