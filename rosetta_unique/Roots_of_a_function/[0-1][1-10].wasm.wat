(module
  ...
  (func $frexp (type 16) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $f (type 2) (param f64) (result f64)
    (f64.add
      (f64.add
        (local.get 0)
        (local.get 0))
      (f64.add
        ...
        (f64.mul
          ...
          (local.get 0)))))
  (func $secant (type 17) (param f64 f64 i32) (result f64)
    (local i32 f64 i32 f64 f64 i32 i32)
    (global.set 0
      (local.tee 3
        (i32.sub
          (global.get 0)
    ...
    (global.set 0
      (local.tee 2
        (i32.sub
          ...
          (i32.const 48))))
    (local.set 3
      (f64.const -0x1.083126e978d5p+0 (;=-1.032;)))
    (local.set 4
      (f64.gt
        (call $f
          (f64.const -0x1.083126e978d5p+0 (;=-1.032;)))
