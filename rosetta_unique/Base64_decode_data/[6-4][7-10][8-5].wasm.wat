(module
  ...
  (func $decode (type 5) (param i32 i32) (result i32)
    ...
    (block  ;; label = @1
      ...
      (i32.store8
        ...
        (i32.const 0)))
    (local.get 2))
  (func $findIndex (type 4) (param i32) (result i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
  ...
  (export "findIndex" (func $findIndex))
  (export "decode" (func $decode))
  (export "BASE64" (global 21))
