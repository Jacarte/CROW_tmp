(module
  ...
  (func $__original_main (type 12) (result i32)
    (call $pascaltriangle
      (i32.const 8))
    (i32.const 0))
  (func $pascaltriangle (type 2) (param i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 1
        (i32.sub
  ...
  (export "pascaltriangle" (func $pascaltriangle))
