(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 48)))
    (i32.const 0))
  (func $thing1 (type 2) (param i32) (result i32)
    (local i32)
    (global.set 0
      (local.tee 1
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 3624))
  (func $NewDelegate (type 2) (param i32) (result i32)
    (local i32)
    (i32.store
      (local.tee 1
        (call $malloc
      ...
      (local.get 0))
    (local.get 1))
  (func $NewDelegator (type 5) (param i32 i32) (result i32)
    (local i32)
    (i32.store
      (local.tee 2
        (call $malloc
    ...
    (i32.store offset=8
      ...
      (i32.const 3884))
    (local.get 2))
  (func $Delegator_Operation (type 0) (param i32 i32 i32) (result i32)
    (local i32)
    (global.set 0
      (local.tee 3
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (local.get 2))
  (func $DelegateThing (type 5) (param i32 i32) (result i32)
    (local i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
      ...
      (local.set 2
        (call_indirect (type 2)
          ...
          (local.get 0))))
    (local.get 2))
  (func $defaultResponse (type 2) (param i32) (result i32)
    (i32.const 3570))
  ...
  (export "NewDelegate" (func $NewDelegate))
  (export "DelegateThing" (func $DelegateThing))
  (export "defaultResponse" (func $defaultResponse))
  (export "NewDelegator" (func $NewDelegator))
  (export "Delegator_Operation" (func $Delegator_Operation))
  (export "thing1" (func $thing1))
