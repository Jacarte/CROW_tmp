(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (call $show_sym_diff
      ...
      (i32.const 5))
    (i32.const 0))
  (func $uniq (type 10) (param i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
        ...
        (br_if 0 (;@5;)
          (i32.and
            (i32.ne
              ...
              (local.get 1))
            (i32.const 1))))))
  (func $show_diff (type 11) (param i32 i32 i32 i32)
    (local i32 i32)
    (global.set 0
      (local.tee 4
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 4)
        (i32.const 16))))
  (func $show_sym_diff (type 11) (param i32 i32 i32 i32)
    (call $show_diff
      (local.get 0)
      (local.get 1)
      (local.get 2)
    ...
    (call $show_diff
      ...
      (local.get 0)
      (local.get 1)))
  (func $in_set (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32)
    (local.set 3
      (i32.const 0))
    (block  ;; label = @1
  ...
  (global (;24;) i32 (i32.const 5528))
  (global (;25;) i32 (i32.const 1024))
  (global (;26;) i32 (i32.const 71072))
  ...
  (export "in_set" (func $in_set))
  (export "show_diff" (func $show_diff))
  (export "show_sym_diff" (func $show_sym_diff))
  (export "A" (global 21))
  (export "B" (global 22))
