  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 112)))
    (i32.const 0))
  (func $comb (type 14) (param i32 i32 i32)
