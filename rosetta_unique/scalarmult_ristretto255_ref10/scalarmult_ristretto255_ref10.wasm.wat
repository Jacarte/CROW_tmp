(module
  ...
  (import "env" "ristretto255_frombytes" (func $ristretto255_frombytes (type 3)))
  (import "env" "ge25519_scalarmult" (func $ge25519_scalarmult (type 7)))
  (import "env" "ristretto255_p3_tobytes" (func $ristretto255_p3_tobytes (type 8)))
  (import "env" "sodium_is_zero" (func $sodium_is_zero (type 3)))
  (import "env" "ge25519_scalarmult_base" (func $ge25519_scalarmult_base (type 8)))
  ...
  (func $printf_core (type 14) (param i32 i32 i32 i32 i32) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 880)))
    (local.get 15))
  (func $pop_arg (type 7) (param i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.gt_u
          (local.tee 1
  ...
  (func $frexp (type 15) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $crypto_scalarmult_ristretto255 (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32)
    (global.set 0
      (local.tee 3
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 320)))
    (local.get 4))
  (func $crypto_scalarmult_ristretto255_base (type 3) (param i32 i32) (result i32)
    (local i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (i32.sub
      ...
      (i32.and
        (i32.ne
          ...
          (i32.const 0))
        (i32.const 1))))
  (func $crypto_scalarmult_ristretto255_bytes (type 12) (result i32)
    (i32.const 32))
  (func $crypto_scalarmult_ristretto255_scalarbytes (type 12) (result i32)
    (i32.const 32))
  (table (;0;) 5 5 funcref)
  (memory (;0;) 2)
  ...
  (export "crypto_scalarmult_ristretto255" (func $crypto_scalarmult_ristretto255))
  (export "crypto_scalarmult_ristretto255_base" (func $crypto_scalarmult_ristretto255_base))
  (export "crypto_scalarmult_ristretto255_bytes" (func $crypto_scalarmult_ristretto255_bytes))
  (export "crypto_scalarmult_ristretto255_scalarbytes" (func $crypto_scalarmult_ristretto255_scalarbytes))
