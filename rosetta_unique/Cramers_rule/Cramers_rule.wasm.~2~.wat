(module
  ...
  (type (;17;) (func (param i32 f64 i32 i32) (result f64)))
  ...
  (func $puts (type 5) (param i32) (result i32)
    ...
    (i32.shr_s
      (call $__overflow
        ...
        (i32.const 10))
      (i32.const 31)))
  (func $init_square_matrix (type 14) (param i32 i32 i32)
    (local i32 i32 i32 i32 i32)
    (i32.store
      (local.get 0)
      (local.get 1))
        ...
        (br_if 0 (;@3;)
          (i32.and
            (i32.lt_s
              ...
              (local.get 1))
            (i32.const 1))))))
  (func $copy_square_matrix (type 10) (param i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    (i32.store
      (local.get 0)
      (local.tee 2
        ...
        (br_if 0 (;@4;)
          (i32.and
            (i32.lt_s
              ...
              (local.get 2))
            (i32.const 1))))))
  (func $det (type 16) (param i32) (result f64)
    (local f64 i32 i32 i32 i32 i32 i32 i32 i32 i32 f64 i32 i32 i32 i32)
    (local.set 1
      (f64.const 0x1p+0 (;=1;)))
    (block  ;; label = @1
      (block  ;; label = @2
      ...
      (loop  ;; label = @21
        ...
        (br_if 0 (;@21;)
          (i32.and
            ...
            (i32.const 1)))))
    (local.get 11))
  (func $deinit_square_matrix (type 2) (param i32)
    (local i32 i32 i32)
    (local.set 1
      (i32.const 0))
    (block  ;; label = @1
    ...
    (call $free
      (i32.load offset=4
        (local.get 0))))
  (func $cramer_solve (type 17) (param i32 f64 i32 i32) (result f64)
  ...
  (export "init_square_matrix" (func $init_square_matrix))
  (export "copy_square_matrix" (func $copy_square_matrix))
  (export "det" (func $det))
  (export "deinit_square_matrix" (func $deinit_square_matrix))
  (export "cramer_solve" (func $cramer_solve))
