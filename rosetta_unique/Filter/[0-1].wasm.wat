(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 80)))
    (i32.const 0))
  (func $even_sel (type 2) (param i32) (result i32)
    (i32.and
      (i32.sub
        (local.get 0)
        (i32.const 1162060007))
      (i32.const 1)))
  (func $grep (type 13) (param i32 i32 i32 i32 i32) (result i32)
    (local i32 i32 i32)
    (local.set 5
      (i32.const 0))
    (local.set 6
    ...
    (i32.store
      ...
      (local.get 5))
    (local.get 6))
  (func $tri_sel (type 2) (param i32) (result i32)
    (i32.rem_s
      (local.get 0)
      (i32.const 3)))
  ...
  (export "even_sel" (func $even_sel))
  (export "tri_sel" (func $tri_sel))
  (export "grep" (func $grep))
