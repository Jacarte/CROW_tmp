  ...
  (func $is_prime (type 5) (param i32) (result i32)
    ...
    (block  ;; label = @1
      ...
      (local.set 1
        (i32.const 0)))
    (local.get 1))
  (func $reverse (type 5) (param i32) (result i32)
    (local i32 i32)
    (local.set 1
      (i32.const 0))
    (block  ;; label = @1
      ...
      (loop  ;; label = @2
        ...
        (br_if 0 (;@2;)
          (i32.and
            ...
            (i32.const 1)))))
    (local.get 1))
  (func $is_emirp (type 5) (param i32) (result i32)
    (local i32 i32)
    (local.set 1
      (i32.const 0))
    (block  ;; label = @1
