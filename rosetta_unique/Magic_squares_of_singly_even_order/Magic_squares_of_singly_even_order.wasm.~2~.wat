  ...
  (func $atoi (type 5) (param i32) (result i32)
    ...
    (select
      ...
      (i32.sub
        ...
        (local.get 2))
      (local.get 4)))
  (func $oddMagicSquare (type 5) (param i32) (result i32)
    (local i32 i32 i32 i32 i32 i32)
    (local.set 1
      (i32.const 0))
    (block  ;; label = @1
      ...
      (loop  ;; label = @4
        ...
        (br_if 0 (;@8;)
          (i32.and
            ...
            (i32.const 1)))))
    (local.get 1))
  (func $singlyEvenMagicSquare (type 5) (param i32) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (local.get 2))
  (func $numDigits (type 5) (param i32) (result i32)
    (local i32)
    (local.set 1
      (i32.const 1))
    (block  ;; label = @1
      ...
      (loop  ;; label = @2
        ...
        (br_if 0 (;@2;)
          (i32.and
            ...
            (i32.const 1)))))
    (local.get 1))
  (func $printMagicSquare (type 10) (param i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
