      ...
      (i32.store align=1
        (local.tee 1
          (i32.add
            ...
            (call $strlen
              (local.get 0))))
        (i32.load offset=3544 align=1
          (i32.const 0)))
      (i32.store8
        (i32.add
          (local.get 1)
          (i32.const 4))
        (i32.load8_u offset=3548
          (i32.const 0)))
      (drop
        (call $puts
          (local.get 0))))
