(module
  ...
  (func $atoi (type 5) (param i32) (result i32)
    ...
    (select
      ...
      (i32.sub
        ...
        (local.get 2))
      (local.get 4)))
  (func $getWater (type 6) (param i32 i32 i32 i32) (result i32)
    (local i32 i32)
    (local.set 4
      (i32.const 0))
    (block  ;; label = @1
        ...
        (br_if 0 (;@2;)
          (local.tee 1
            (i32.add
              ...
              (i32.const -1))))))
    (local.get 4))
  (func $netWater (type 3) (param i32 i32) (result i32)
  ...
  (export "getWater" (func $getWater))
  (export "netWater" (func $netWater))
