(module
  ...
  (import "env" "crypto_kdf_blake2b_derive_from_key" (func $crypto_kdf_blake2b_derive_from_key (type 7)))
  ...
  (func $frexp (type 16) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $crypto_kdf_primitive (type 12) (result i32)
    (i32.const 3520))
  (func $crypto_kdf_bytes_min (type 12) (result i32)
    (i32.const 16))
  (func $crypto_kdf_bytes_max (type 12) (result i32)
    (i32.const 64))
  (func $crypto_kdf_contextbytes (type 12) (result i32)
    (i32.const 8))
  (func $crypto_kdf_keybytes (type 12) (result i32)
    (i32.const 32))
  (func $crypto_kdf_derive_from_key (type 7) (param i32 i32 i64 i32 i32) (result i32)
    (call $crypto_kdf_blake2b_derive_from_key
      (local.get 0)
      (local.get 1)
      (local.get 2)
      (local.get 3)
      (local.get 4)))
  (func $crypto_kdf_keygen (type 2) (param i32)
  ...
  (export "crypto_kdf_primitive" (func $crypto_kdf_primitive))
  (export "crypto_kdf_bytes_min" (func $crypto_kdf_bytes_min))
  (export "crypto_kdf_bytes_max" (func $crypto_kdf_bytes_max))
  (export "crypto_kdf_contextbytes" (func $crypto_kdf_contextbytes))
  (export "crypto_kdf_keybytes" (func $crypto_kdf_keybytes))
  (export "crypto_kdf_derive_from_key" (func $crypto_kdf_derive_from_key))
  (export "crypto_kdf_keygen" (func $crypto_kdf_keygen))
