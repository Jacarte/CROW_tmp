(module
  ...
  (func $putchar (type 5) (param i32) (result i32)
    ...
    (call $__overflow
      (i32.const 3720)
      (local.get 1)))
  (func $cycleSort (type 3) (param i32 i32) (result i32)
  ...
  (func $main (type 3) (param i32 i32) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 80)))
    (i32.const 0))
  (func $show_array (type 10) (param i32 i32)
    (local i32)
    (global.set 0
      (local.tee 2
        (i32.sub
  ...
  (export "cycleSort" (func $cycleSort))
  (export "show_array" (func $show_array))
