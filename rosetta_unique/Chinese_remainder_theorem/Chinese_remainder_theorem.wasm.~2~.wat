(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 48)))
    (i32.const 0))
  (func $chinese_remainder (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32)
    (local.set 3
      (i32.const 0))
    (local.set 4
    ...
    (i32.rem_s
      (local.get 3)
      (local.get 4)))
  (func $mul_inv (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32)
    (local.set 2
      (i32.const 1))
    (block  ;; label = @1
  ...
  (export "mul_inv" (func $mul_inv))
  (export "chinese_remainder" (func $chinese_remainder))
