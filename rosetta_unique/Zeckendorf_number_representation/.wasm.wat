(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $fibbinary (type 16) (param i64) (result i64)
      ...
      (loop  ;; label = @2
        ...
        (br_if 0 (;@3;)
          (i32.and
            ...
            (i32.const 1)))))
    (local.get 1))
  (func $bprint (type 17) (param i64 i32)
    (local i64)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
  ...
  (global (;23;) i32 (i32.const 5944))
  (global (;24;) i32 (i32.const 1024))
  (global (;25;) i32 (i32.const 71488))
