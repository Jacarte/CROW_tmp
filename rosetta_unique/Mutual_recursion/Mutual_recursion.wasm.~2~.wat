          ...
          (call $M
            (call $F
              (i32.sub
                ...
                (i32.const 1)))))))
    (local.get 1))
  (func $M (type 4) (param i32) (result i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
          (i32.and
