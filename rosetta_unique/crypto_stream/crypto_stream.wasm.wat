(module
  ...
  (import "env" "crypto_stream_xsalsa20" (func $crypto_stream_xsalsa20 (type 4)))
  (import "env" "crypto_stream_xsalsa20_xor" (func $crypto_stream_xsalsa20_xor (type 7)))
  ...
  (func $frexp (type 16) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $crypto_stream_keybytes (type 12) (result i32)
    (i32.const 32))
  (func $crypto_stream_noncebytes (type 12) (result i32)
    (i32.const 24))
  (func $crypto_stream_messagebytes_max (type 12) (result i32)
    (i32.const -1))
  (func $crypto_stream_primitive (type 12) (result i32)
    (i32.const 3520))
  (func $crypto_stream (type 4) (param i32 i64 i32 i32) (result i32)
    (call $crypto_stream_xsalsa20
      (local.get 0)
      (local.get 1)
      (local.get 2)
      (local.get 3)))
  (func $crypto_stream_xor (type 7) (param i32 i32 i64 i32 i32) (result i32)
    (call $crypto_stream_xsalsa20_xor
      (local.get 0)
      (local.get 1)
      (local.get 2)
      (local.get 3)
      (local.get 4)))
  (func $crypto_stream_keygen (type 2) (param i32)
  ...
  (export "crypto_stream_keybytes" (func $crypto_stream_keybytes))
  (export "crypto_stream_noncebytes" (func $crypto_stream_noncebytes))
  (export "crypto_stream_messagebytes_max" (func $crypto_stream_messagebytes_max))
  (export "crypto_stream_primitive" (func $crypto_stream_primitive))
  (export "crypto_stream" (func $crypto_stream))
  (export "crypto_stream_xor" (func $crypto_stream_xor))
  (export "crypto_stream_keygen" (func $crypto_stream_keygen))
