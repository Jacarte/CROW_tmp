  ...
  (func $__overflow (type 4) (param i32 i32) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (local.get 3))
  (func $puts (type 6) (param i32) (result i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.ge_s
          (call $fputs
    ...
    (i32.shr_s
      (call $__overflow
        ...
        (i32.const 10))
      (i32.const 31)))
  (func $repeat (type 10) (param i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
          (local.get 1)))
