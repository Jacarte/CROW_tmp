(module
  ...
  (func $frexp (type 15) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $escrypt_alloc_region (type 3) (param i32 i32) (result i32)
    (local i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (local.get 3))
  (func $escrypt_free_region (type 5) (param i32) (result i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
    ...
    (i32.store offset=8
      ...
      (i32.const 0))
    (i32.const 0))
  (func $escrypt_init_local (type 5) (param i32) (result i32)
    (i32.store offset=4
      (local.get 0)
      (i32.const 0))
    (i32.store
    ...
    (i32.store offset=8
      ...
      (i32.const 0))
    (i32.const 0))
  (func $escrypt_free_local (type 5) (param i32) (result i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
  ...
  (export "escrypt_alloc_region" (func $escrypt_alloc_region))
  (export "escrypt_free_region" (func $escrypt_free_region))
  (export "escrypt_init_local" (func $escrypt_init_local))
  (export "escrypt_free_local" (func $escrypt_free_local))
