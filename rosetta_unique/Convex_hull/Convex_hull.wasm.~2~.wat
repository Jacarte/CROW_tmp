(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 160)))
    (i32.const 0))
  (func $convexHull (type 2) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
  ...
  (func $print (type 3) (param i32)
    ...
    (global.set 0
      (i32.add
        (local.get 1)
        (i32.const 32))))
  (func $freeNode (type 3) (param i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
          (i32.eqz
      ...
      (call $free
        (local.get 0))))
  (func $comp (type 2) (param i32 i32) (result i32)
    (local i32)
    (local.set 2
      (i32.const -1))
    (block  ;; label = @1
      ...
      (local.set 2
        (i32.const 0)))
    (local.get 2))
  (func $ccw (type 0) (param i32 i32 i32) (result i32)
    (local i32)
    (i32.and
      (i32.gt_s
        (i32.mul
        ...
        (i32.mul
          ...
          (i32.sub
            ...
            (local.get 3))))
      (i32.const 1)))
  (func $popBack (type 5) (param i32) (result i32)
    (local i32 i32)
    (local.set 1
      (i32.const 0))
    (block  ;; label = @1
  ...
  (export "ccw" (func $ccw))
  (export "comp" (func $comp))
  (export "freeNode" (func $freeNode))
  (export "pushBack" (func $pushBack))
  (export "popBack" (func $popBack))
  (export "print" (func $print))
  (export "convexHull" (func $convexHull))
