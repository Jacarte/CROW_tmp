(module
  ...
  (import "env" "crypto_shorthash_siphash24" (func $crypto_shorthash_siphash24 (type 7)))
  ...
  (func $frexp (type 16) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $crypto_shorthash_bytes (type 12) (result i32)
    (i32.const 8))
  (func $crypto_shorthash_keybytes (type 12) (result i32)
    (i32.const 16))
  (func $crypto_shorthash_primitive (type 12) (result i32)
    (i32.const 3520))
  (func $crypto_shorthash (type 7) (param i32 i32 i64 i32) (result i32)
    (call $crypto_shorthash_siphash24
      (local.get 0)
      (local.get 1)
      (local.get 2)
      (local.get 3)))
  (func $crypto_shorthash_keygen (type 2) (param i32)
  ...
  (export "crypto_shorthash_bytes" (func $crypto_shorthash_bytes))
  (export "crypto_shorthash_keybytes" (func $crypto_shorthash_keybytes))
  (export "crypto_shorthash_primitive" (func $crypto_shorthash_primitive))
  (export "crypto_shorthash" (func $crypto_shorthash))
  (export "crypto_shorthash_keygen" (func $crypto_shorthash_keygen))
