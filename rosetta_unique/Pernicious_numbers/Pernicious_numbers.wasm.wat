  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 32)))
    (i32.const 0))
  (func $is_pern (type 4) (param i32) (result i32)
    (local i32)
    (local.set 1
      (i32.const -1601558356))
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
          (i32.xor
