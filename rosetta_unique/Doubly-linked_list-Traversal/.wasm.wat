(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 32)))
    (i32.const 0))
  (func $NewList (type 12) (result i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
      ...
      (i64.store align=4
        ...
        (i64.const 0)))
    (local.get 0))
  (func $LL_Append (type 5) (param i32 i32) (result i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
    ...
    (i32.ne
      (local.get 2)
      (i32.const 0)))
  (func $LL_GetIterator (type 4) (param i32) (result i32)
    (local i32)
    (i32.store
      (local.tee 1
        (call $malloc
    ...
    (i32.store offset=4
      ...
      (local.get 0))
    (local.get 1))
  (func $LLI_Next (type 4) (param i32) (result i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
    ...
    (i32.ne
      (i32.load
        (local.get 0))
      (i32.const 0)))
  (func $LLI_Value (type 4) (param i32) (result i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (local.tee 0
          (i32.load
    ...
    (i32.load
      (local.get 0)))
  (func $LLI_Prev (type 4) (param i32) (result i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
    ...
    (i32.ne
      (i32.load
        (local.get 0))
      (i32.const 0)))
  (func $LI_Insert (type 5) (param i32 i32) (result i32)
    (local i32 i32)
    (local.set 2
      (i32.load
        (local.get 0)))
    ...
    (i32.ne
      (local.get 3)
      (i32.const 0)))
  (func $LLI_AtEnd (type 4) (param i32) (result i32)
    (i32.eqz
      (i32.load
        (local.get 0))))
  ...
  (export "NewList" (func $NewList))
  (export "LL_Append" (func $LL_Append))
  (export "LI_Insert" (func $LI_Insert))
  (export "LL_GetIterator" (func $LL_GetIterator))
  (export "LLI_AtEnd" (func $LLI_AtEnd))
  (export "LLI_Value" (func $LLI_Value))
  (export "LLI_Next" (func $LLI_Next))
  (export "LLI_Prev" (func $LLI_Prev))
