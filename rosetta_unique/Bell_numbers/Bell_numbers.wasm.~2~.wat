(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 48)))
    (i32.const 0))
  (func $bellTriangle (type 4) (param i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    (call $setBell
      (local.tee 1
        (call $calloc
      ...
      (loop  ;; label = @2
        ...
        (br_if 0 (;@3;)
          (i32.and
            ...
            (i32.const 1)))))
    (local.get 1))
  (func $getBell (type 0) (param i32 i32 i32) (result i32)
    (i32.load
      (i32.add
        (local.get 0)
        (i32.shl
          (call $bellIndex
            ...
            (local.get 2))
          (i32.const 2)))))
  (func $setBell (type 11) (param i32 i32 i32 i32)
    (i32.store
      (i32.add
        (local.get 0)
        (i32.shl
          ...
          (i32.const 2)))
      (local.get 3)))
  (func $bellIndex (type 5) (param i32 i32) (result i32)
    (i32.add
      (i32.div_s
        (i32.mul
          (local.get 0)
  ...
  (export "bellIndex" (func $bellIndex))
  (export "getBell" (func $getBell))
  (export "setBell" (func $setBell))
  (export "bellTriangle" (func $bellTriangle))
