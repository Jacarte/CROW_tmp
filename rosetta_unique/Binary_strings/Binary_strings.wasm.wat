(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $str_from_chars (type 4) (param i32) (result i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (local.get 0))
    ...
    (drop
      (call $memcpy
        ...
        (local.get 1)))
    (local.get 2))
  (func $str_subst (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32 i32)
    (local.set 3
      (i32.const 0))
    (local.set 4
    ...
    (call $str_del
      (local.get 4))
    (local.get 0))
  (func $str_del (type 2) (param i32)
    (call $free
      (i32.load offset=8
        (local.get 0)))
    (call $free
      (local.get 0)))
  (func $str_new (type 4) (param i32) (result i32)
    (local i32)
    (i32.store offset=4
      (local.tee 1
        (call $malloc
    ...
    (i32.store offset=8
      ...
      (local.get 0))
    (local.get 1))
  (func $str_append (type 10) (param i32 i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.lt_u
    ...
    (i32.store8
      (i32.add
        ...
        (i32.load offset=8
          (local.get 0)))
      (local.get 1)))
  (func $str_cat (type 5) (param i32 i32) (result i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.ge_u
    ...
    (i32.store
      ...
      (i32.add
        ...
        (i32.load
          (local.get 1))))
    (local.get 0))
  (func $str_swap (type 10) (param i32 i32)
    (local i32 i32 i32)
    (local.set 2
      (i32.load offset=4
        (local.get 0)))
    ...
    (i32.store offset=8
      (local.get 1)
      (local.get 4)))
  (func $str_extend (type 2) (param i32)
    (local i32 i32)
    (local.set 2
      (call $realloc
        (i32.load offset=8
    ...
    (i32.store offset=8
      (local.get 0)
      (local.get 2)))
  (func $str_cmp (type 5) (param i32 i32) (result i32)
    (select
      (local.tee 1
        (call $memcmp
          (i32.load offset=8
      ...
      (select
        ...
        (local.get 0))
      (local.get 1)))
  (func $str_dup (type 4) (param i32) (result i32)
    (local i32)
    (drop
      (call $memcpy
        (i32.load offset=8
    ...
    (i32.store
      ...
      (i32.load
        (local.get 0)))
    (local.get 1))
  (func $str_substr (type 0) (param i32 i32 i32) (result i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (local.get 2))
    ...
    (block  ;; label = @3
      ...
      (drop
        (call $memcpy
          ...
          (local.get 2))))
    (local.get 3))
  (func $str_set (type 10) (param i32 i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.ge_u
  ...
  (global (;19;) i32 (i32.const 5432))
  (global (;20;) i32 (i32.const 3512))
  (global (;21;) i32 (i32.const 1024))
  (global (;22;) i32 (i32.const 5444))
  (global (;23;) i32 (i32.const 1024))
  (global (;24;) i32 (i32.const 70992))
  ...
  (export "str_extend" (func $str_extend))
  (export "str_del" (func $str_del))
  (export "str_cmp" (func $str_cmp))
  (export "str_dup" (func $str_dup))
  (export "str_from_chars" (func $str_from_chars))
  (export "str_append" (func $str_append))
  (export "str_substr" (func $str_substr))
  (export "str_cat" (func $str_cat))
  (export "str_swap" (func $str_swap))
  (export "str_subst" (func $str_subst))
  (export "str_set" (func $str_set))
