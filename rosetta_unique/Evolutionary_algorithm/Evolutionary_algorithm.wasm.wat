(module
  ...
  (func $irand (type 4) (param i32) (result i32)
    ...
    (i32.div_s
      ...
      (i32.div_s
        (local.get 1)
        (local.get 0))))
  (func $mutate (type 10) (param i32 i32)
    (local i32 i32 i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
    ...
    (i32.store8
      (i32.add
        ...
        (local.get 2))
      (i32.const 0)))
  (func $unfitness (type 5) (param i32 i32) (result i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (local.tee 2
  ...
  (global (;21;) i32 (i32.const 3552))
  (global (;22;) i32 (i32.const 3520))
  (global (;23;) i32 (i32.const 1024))
  (global (;24;) i32 (i32.const 5520))
  ...
  (export "unfitness" (func $unfitness))
  (export "mutate" (func $mutate))
  (export "target" (global 21))
  (export "tbl" (global 22))
