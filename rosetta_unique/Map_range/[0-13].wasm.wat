(module
  ...
  (type (;16;) (func (param f64 f64 f64 f64 f64) (result f64)))
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $mapRange (type 16) (param f64 f64 f64 f64 f64) (result f64)
    (f64.add
      (local.get 2)
      (f64.div
        (f64.mul
