(module
  ...
  (func $compare (type 2) (param i32 i32) (result i32)
    (i32.sub
      ...
      (i32.load
        (local.get 1))))
  (func $generic_fizz_buzz (type 14) (param i32 i32 i32)
    (local i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 3
        (i32.sub
  ...
  (export "generic_fizz_buzz" (func $generic_fizz_buzz))
