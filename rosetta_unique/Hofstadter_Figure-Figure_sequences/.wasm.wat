(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (call $abort)
    (unreachable))
  (func $push (type 16) (param i32 i64)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.gt_u
    ...
    (i64.store
      (i32.add
        ...
        (i32.shl
          ...
          (i32.const 3)))
      (local.get 1)))
  (func $R (type 17) (param i32) (result i64)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.ge_u
      ...
      (i32.add
        (i32.add
          ...
          (i32.load offset=5468
            (i32.const 0)))
        (i32.const -8))))
  (func $S (type 17) (param i32) (result i64)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.ge_u
      ...
      (i32.add
        (i32.add
          ...
          (i32.load offset=5480
            (i32.const 0)))
        (i32.const -8))))
  (func $setsize (type 10) (param i32 i32)
    (local i32 i32 i32)
    (local.set 3
      (select
        (local.tee 2
  ...
  (global (;21;) i32 (i32.const 5460))
  (global (;22;) i32 (i32.const 5472))
  (global (;23;) i32 (i32.const 1024))
  (global (;24;) i32 (i32.const 5484))
  (global (;25;) i32 (i32.const 1024))
  (global (;26;) i32 (i32.const 71024))
  ...
  (export "R" (func $R))
  (export "RS_append" (func $RS_append))
  (export "S" (func $S))
  (export "rs" (global 21))
  (export "ss" (global 22))
