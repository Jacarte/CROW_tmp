(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 48)))
    (i32.const 0))
  (func $gen_n (type 16) (param i32 i32) (result i64)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 4096)))
    (local.get 3))
  (func $sub_fact (type 17) (param i32) (result i64)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
    ...
    (i64.mul
      ...
      (i64.extend_i32_u
        (local.get 1))))
  (func $deranged (type 18) (param i32 i32 i32 i32) (result i64)
    (local i64 i32 i32 i32 i32 i32 i32 i64)
    (block  ;; label = @1
      (block  ;; label = @2
        (br_if 0 (;@2;)
          (i32.and
  ...
  (export "deranged" (func $deranged))
  (export "gen_n" (func $gen_n))
  (export "sub_fact" (func $sub_fact))
