(module
    ...
    (i64.store
      (i32.add
        ...
        (i32.shl
          ...
          (i32.const 3)))
      (local.get 0)))
  (func $qpop (type 17) (result i64)
    (local i32 i64 i32 i32 i32 i64 i32 i32 i64)
    (local.set 1
      (i64.load offset=8
        (local.tee 0
          (i32.load offset=5416
  ...
  (global (;25;) i32 (i32.const 5424))
  (global (;26;) i32 (i32.const 1024))
  (global (;27;) i32 (i32.const 70960))
  ...
  (export "qpush" (func $qpush))
  (export "qpop" (func $qpop))
  (export "alloc" (global 21))
  (export "n" (global 22))
  (export "q" (global 23))
