(module
  ...
  (type (;2;) (func (param i32 i32 i32 f64) (result i32)))
  ...
  (func $__original_main (type 13) (result i32)
    ...
    (i64.store
      (local.get 8)
      (i64.const -4606056518893174784))
    (i64.store offset=136
      (local.get 0)
      (i64.const 0))
    (i64.store offset=128
      (local.get 0)
      (i64.const -4601552919265804288))
    (i32.store offset=80
      (local.get 0)
      (call $triTri2D
        (i32.add
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 224)))
    (i32.const 0))
  (func $triTri2D (type 17) (param i32 i32 f64 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32)
    (call $checkTriWinding
      (local.get 0)
      (local.tee 5
        (i32.add
          (local.get 0)
      ...
      (loop  ;; label = @4
        ...
        (br_if 0 (;@5;)
          (i32.ne
            ...
            (i32.const 4)))))
    (local.get 7))
  (func $checkTriWinding (type 12) (param i32 i32 i32 i32)
    (local i64 i64)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.xor
      ...
      (i32.store offset=4340
        (i32.const 0)
        (i32.const 1))))
  (func $boundaryCollideChk (type 2) (param i32 i32 i32 f64) (result i32)
    (f64.lt
      (call $det2D
        (local.get 0)
        (local.get 1)
        (local.get 2))
      (local.get 3)))
  (func $boundaryDoesntCollideChk (type 2) (param i32 i32 i32 f64) (result i32)
    (f64.le
      (call $det2D
        (local.get 0)
        (local.get 1)
        (local.get 2))
      (local.get 3)))
  (func $det2D (type 18) (param i32 i32 i32) (result f64)
    (local f64 f64 f64)
    (f64.add
      (f64.mul
        (f64.load
  ...
  (export "det2D" (func $det2D))
  (export "checkTriWinding" (func $checkTriWinding))
  (export "boundaryCollideChk" (func $boundaryCollideChk))
  (export "boundaryDoesntCollideChk" (func $boundaryDoesntCollideChk))
  (export "triTri2D" (func $triTri2D))
