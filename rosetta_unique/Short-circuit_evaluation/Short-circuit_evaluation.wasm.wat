  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 64)))
    (i32.const 0))
  (func $a (type 4) (param i32) (result i32)
    (drop
      (call $printf
        (i32.const 3624)
        (i32.const 0)))
    (i32.and
      (local.get 0)
      (i32.const 1)))
  (func $b (type 4) (param i32) (result i32)
    (drop
      (call $printf
        (i32.const 3616)
        (i32.const 0)))
