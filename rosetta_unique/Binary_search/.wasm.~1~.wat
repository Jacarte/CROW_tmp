(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 80)))
    (i32.const 0))
  (func $bsearch (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32)
    (local.set 3
      (i32.add
        (local.get 1)
    ...
    (loop  ;; label = @1
      ...
      (br_if 0 (;@4;)
        (local.get 4)))
    (local.get 7))
  (func $bsearch_r (type 6) (param i32 i32 i32 i32) (result i32)
    (local i32 i32)
    (local.set 4
      (i32.const -1))
    (block  ;; label = @1
  ...
  (export "bsearch_r" (func $bsearch_r))
