(module
  ...
  (func $frexp (type 15) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $cbrt (type 16) (param f64) (result f64)
                                  ...
                                  (f64.add
                                    (f64.mul
                                      ...
                                      (f64.add
                                        (f64.mul
                                          (local.get 5)
                                          (f64.const 0x1.2b000d4e4edd7p-3 (;=0.145996;)))
                                        (f64.const -0x1.844cbbee751d9p-1 (;=-0.758398;))))
                                    (f64.add
                                      (f64.mul
                                        (local.get 5)
                                        (f64.add
                                          (f64.mul
                                            (local.get 5)
                                            (f64.const 0x1.9f1604a49d6c2p+0 (;=1.62143;)))
                                          (f64.const -0x1.e28e092f0242p+0 (;=-1.88498;))))
                                      (f64.const 0x1.e03e60f61e692p+0 (;=1.87595;))))
                                  (local.get 4)))
