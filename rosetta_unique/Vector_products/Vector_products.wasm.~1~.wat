(module
  ...
  (func $printVector (type 2) (param i32)
    ...
    (global.set 0
      (i32.add
        (local.get 1)
        (i32.const 32))))
  (func $dotProduct (type 16) (param i32 i32) (result f32)
    (f32.add
      (f32.add
        (f32.mul
          (f32.load
      ...
      (f32.mul
        ...
        (f32.load offset=8
          (local.get 1)))))
  (func $crossProduct (type 14) (param i32 i32 i32)
    ...
    (f32.store offset=4
      ...
      (f32.sub
        ...
        (f32.mul
          (local.get 4)
          (local.get 7)))))
  (func $scalarTripleProduct (type 17) (param i32 i32 i32) (result f32)
    (local i32 i64 f32)
    (global.set 0
      (local.tee 3
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 80)))
    (local.get 5))
  (func $vectorTripleProduct (type 11) (param i32 i32 i32 i32)
    (local i32 i64)
    (global.set 0
      (local.tee 4
        (i32.sub
  ...
  (global (;21;) i32 (i32.const 3852))
  (global (;22;) i32 (i32.const 3864))
  (global (;23;) i32 (i32.const 3876))
  (global (;24;) i32 (i32.const 1024))
  (global (;25;) i32 (i32.const 5540))
  (global (;26;) i32 (i32.const 1024))
  (global (;27;) i32 (i32.const 71088))
  ...
  (export "crossProduct" (func $crossProduct))
  (export "scalarTripleProduct" (func $scalarTripleProduct))
  (export "vectorTripleProduct" (func $vectorTripleProduct))
