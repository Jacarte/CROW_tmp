  ...
  (func $__original_main (type 12) (result i32)
    ...
    (i32.store align=1
      (i32.add
        (local.get 0)
        (i32.const 147))
      (i32.load offset=3531 align=1
        (i32.const 0)))
    (i32.store offset=144
      (local.get 0)
      (i32.load offset=3528 align=1
        (i32.const 0)))
    (drop
      (call $scs
        (i32.add
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 160)))
    (i32.const 0))
  (func $scs (type 0) (param i32 i32 i32) (result i32)
