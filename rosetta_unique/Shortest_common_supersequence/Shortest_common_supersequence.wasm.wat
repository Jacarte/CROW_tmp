(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (i64.store offset=152
      (local.get 0)
      (i64.const 27691631492948577))
    (i32.store offset=147 align=1
      (local.get 0)
      (i32.load offset=3523 align=1
        (i32.const 0)))
