  ...
  (func $__original_main (type 12) (result i32)
    ...
    (drop
      (call $putchar
        (i32.const 10)))
    (i32.const 0))
  (func $fac (type 2) (param i32 i32) (result i32)
    (local i32)
    (local.set 2
      (i32.const 1))
    (block  ;; label = @1
    ...
    (call $num
      (local.get 2)))
  (func $Y (type 5) (param i32) (result i32)
    (i32.store offset=4
      (local.tee 0
        (call $new
          (local.get 0)
      ...
      (local.get 0))
    (local.get 0))
  (func $num (type 5) (param i32) (result i32)
    (local i32)
    (i32.store offset=8
      (local.tee 1
        (call $new
      ...
      (local.get 0))
    (local.get 1))
  (func $call (type 2) (param i32 i32) (result i32)
    (call_indirect (type 2)
      (local.get 0)
      (local.get 1)
      (i32.load
        (local.get 0))))
  (func $show (type 3) (param i32)
    (local i32)
    (global.set 0
      (local.tee 1
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 1)
        (i32.const 16))))
  (func $fib (type 2) (param i32 i32) (result i32)
    (local i32)
    (local.set 2
      (i32.const 1))
    (block  ;; label = @1
    ...
    (call $num
      (local.get 2)))
  (func $new (type 2) (param i32 i32) (result i32)
    (local i32)
    (i32.store offset=8
      (local.tee 2
        (call $malloc
