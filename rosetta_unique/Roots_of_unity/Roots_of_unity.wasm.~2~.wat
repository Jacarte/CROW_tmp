(module
  ...
  (func $__original_main (type 12) (result i32)
    (local i32 i32 i32 i32 f64 i32 i32 f64 i32 f64 f64 i32 i32)
    (global.set 0
      (local.tee 0
        (i32.sub
          (global.get 0)
  ...
  (global (;17;) i32 (i32.const 6624))
  (global (;18;) i32 (i32.const 6504))
