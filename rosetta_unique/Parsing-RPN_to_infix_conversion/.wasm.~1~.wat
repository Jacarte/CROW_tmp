(module
  ...
  (func $putchar (type 5) (param i32) (result i32)
    ...
    (call $__overflow
      (i32.const 3664)
      (local.get 1)))
  (func $precedenceCheck (type 3) (param i32 i32) (result i32)
    (local i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
      ...
      (local.set 2
        (select
          ...
          (i32.eq
            ...
            (i32.const 45)))))
    (local.get 2))
  (func $isOperator (type 5) (param i32) (result i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.ge_u
  ...
  (func $inorder (type 2) (param i32)
    ...
    (global.set 0
      (i32.add
        (local.get 1)
        (i32.const 16))))
  (func $getNextString (type 11) (result i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.gt_s
    ...
    (i32.load
      (i32.add
        ...
        (i32.shl
          (local.get 0)
          (i32.const 2)))))
  (func $buildTree (type 3) (param i32 i32) (result i32)
    (local i32 i32 i32 i32)
    (local.set 3
      (call $strcpy
        (local.tee 2
    ...
    (block  ;; label = @3
      ...
      (call $inorder
        (local.get 2)))
    (local.get 2))
  (func $checkRPN (type 11) (result i32)
    (local i32 i32 i32 i32 i32)
    (local.set 0
      (i32.const 0))
    (block  ;; label = @1
      ...
      (local.set 0
        (i32.eq
          ...
          (i32.const 1))))
    (local.get 0))
  (func $buildStack (type 2) (param i32)
    (local i32 i32)
    (local.set 1
      (local.get 0))
    (loop  ;; label = @1
  ...
  (global (;19;) i32 (i32.const 5544))
  (global (;20;) i32 (i32.const 3512))
  (global (;21;) i32 (i32.const 5560))
  (global (;22;) i32 (i32.const 5564))
  (global (;23;) i32 (i32.const 1024))
  (global (;24;) i32 (i32.const 5568))
  (global (;25;) i32 (i32.const 1024))
  (global (;26;) i32 (i32.const 71104))
  ...
  (export "precedenceCheck" (func $precedenceCheck))
  (export "isOperator" (func $isOperator))
  (export "inorder" (func $inorder))
  (export "getNextString" (func $getNextString))
  (export "buildTree" (func $buildTree))
  (export "checkRPN" (func $checkRPN))
  (export "buildStack" (func $buildStack))
  (export "counter" (global 21))
  (export "components" (global 22))
