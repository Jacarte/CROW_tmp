  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 48)))
    (i32.const 0))
  (func $best_shuffle (type 10) (param i32 i32)
    ...
    (call $__assert_fail
      ...
      (i32.const 3643))
    (unreachable))
  (func $display (type 10) (param i32 i32)
    (local i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
