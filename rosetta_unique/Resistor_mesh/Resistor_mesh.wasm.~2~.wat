(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $alloc2 (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32)
    (local.set 2
      (call $calloc
        (i32.const 1)
      ...
      (loop  ;; label = @2
        ...
        (br_if 0 (;@3;)
          (i32.and
            ...
            (i32.const 1)))))
    (local.get 2))
  (func $iter (type 16) (param i32 i32 i32) (result f64)
    (local i32 i32 i32 f64 i32 i32 i32 i32 i32 i32 i32 i32 f64)
    (global.set 0
      (local.tee 3
        (i32.sub
          (global.get 0)
    ...
    (f64.div
      (f64.sub
        ...
        (local.get 6))
      (f64.const 0x1p+1 (;=2;))))
  (func $set_boundary (type 2) (param i32)
    (local i32)
    (i32.store offset=8
      (i32.add
        (local.tee 1
  ...
  (func $calc_diff (type 17) (param i32 i32 i32 i32) (result f64)
    (local f64 i32 i32 i32 i32 i32 i32 i32 i32 i32 f64 i32 i32 i32)
    (local.set 4
      (f64.const 0x0p+0 (;=0;)))
    (block  ;; label = @1
      (br_if 0 (;@1;)
