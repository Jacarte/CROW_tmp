(module
  ...
  (func $strcpy (type 3) (param i32 i32) (result i32)
    (drop
      (call $__stpcpy
        ...
        (local.get 1)))
    (local.get 0))
  (func $valid_cc (type 3) (param i32 i32) (result i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (call $strncmp
          (local.get 0)
    ...
    (i32.and
      ...
      (i32.eq
        (local.get 1)
        (i32.const 24))))
  (func $strip (type 5) (param i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (local.tee 1
    ...
    (i32.sub
      (local.get 5)
      (local.get 2)))
  (func $mod97 (type 3) (param i32 i32) (result i32)
    (local i32 i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (i32.store16
      (i32.add
        (local.get 2)
        (i32.const 8))
      (i32.load16_u offset=3720 align=1
        (i32.const 0)))
    (i64.store
      (local.get 2)
      (i64.load offset=3712 align=1
        (i32.const 0)))
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.lt_s
    ...
    (i32.rem_s
      (local.get 0)
      (i32.const 97)))
  (func $valid_iban (type 5) (param i32) (result i32)
  ...
  (export "valid_cc" (func $valid_cc))
  (export "strip" (func $strip))
  (export "mod97" (func $mod97))
  (export "valid_iban" (func $valid_iban))
