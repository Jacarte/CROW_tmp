  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $lcm (type 5) (param i32 i32) (result i32)
    (i32.mul
      (i32.div_s
        (local.get 0)
        (call $gcd
