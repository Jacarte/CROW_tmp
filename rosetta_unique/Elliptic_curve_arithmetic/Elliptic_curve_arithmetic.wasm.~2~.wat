(module
  ...
  (func $polybench_timer_print (type 7)
    ...
    (local.set 3
      (i32.const 0))
    (local.set 4
      (f64.load offset=10216
        (local.get 3)))
    (local.set 5
      (i32.const 0))
    (local.set 6
      (f64.load offset=10208
        (local.get 5)))
    (local.set 7
      (f64.sub
        (local.get 4)
                          ...
                          (block  ;; label = @48
                            ...
                            (local.set 4
                              (i32.load offset=10724
                                (i32.const 0)))
                            (br 1 (;@47;)))
                          (i64.store offset=10728 align=4
                            (i32.const 0)
                            (i64.const -1))
                          (i64.store offset=10720 align=4
                            (i32.const 0)
                  ...
                  (block  ;; label = @73
                    ...
                    (i64.store align=4
                      (i32.add
                        (local.get 8)
                        (i32.const 16))
                      (i64.load offset=10700 align=4
                        (i32.const 0)))
                    (i64.store offset=8 align=4
                      (local.get 8)
                      (i64.load offset=10692 align=4
                        (i32.const 0)))
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 496)))
    (i32.const 0))
  (func $from_y (type 20) (param i32 f64)
    (f64.store
      (local.get 0)
      (call $pow
        (f64.sub
  ...
  (func $add (type 14) (param i32 i32 i32)
    ...
    (global.set 0
      (i32.add
        (local.get 3)
        (i32.const 48))))
  (func $neg (type 10) (param i32 i32)
    (f64.store
      (local.get 0)
      (f64.load
        (local.get 1)))
    (f64.store offset=8
      ...
      (f64.neg
        (f64.load offset=8
          (local.get 1)))))
  (func $mul (type 14) (param i32 i32 i32)
    (local i32 i32 i32)
    (global.set 0
      (local.tee 3
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 3)
        (i32.const 64))))
  (func $is_zero (type 4) (param i32) (result i32)
    (local i32 f64)
    (local.set 1
      (i32.const 1))
    (block  ;; label = @1
    ...
    (i32.and
      (local.get 1)
      (i32.const 1)))
  (func $dbl (type 10) (param i32 i32)
  ...
  (table (;0;) 5 5 funcref)
  (memory (;0;) 2)
  (global (;0;) (mut i32) (i32.const 77376))
  (global (;1;) i32 (i32.const 10208))
  (global (;2;) i32 (i32.const 10216))
  (global (;3;) i32 (i32.const 3512))
  (global (;4;) i32 (i32.const 10192))
  (global (;5;) i32 (i32.const 10200))
  (global (;6;) i32 (i32.const 10224))
  (global (;7;) i32 (i32.const 10232))
  (global (;8;) i32 (i32.const 10740))
  (global (;9;) i32 (i32.const 9944))
  (global (;10;) i32 (i32.const 10748))
  (global (;11;) i32 (i32.const 10752))
  (global (;12;) i32 (i32.const 10756))
  (global (;13;) i32 (i32.const 10784))
  (global (;14;) i32 (i32.const 10748))
  (global (;15;) i32 (i32.const 10752))
  (global (;16;) i32 (i32.const 10064))
  (global (;17;) i32 (i32.const 10176))
  (global (;18;) i32 (i32.const 10056))
  (global (;19;) i32 (i32.const 10796))
  (global (;20;) i32 (i32.const 3516))
  (global (;21;) i32 (i32.const 3520))
  (global (;22;) i32 (i32.const 7688))
  (global (;23;) i32 (i32.const 1024))
  (global (;24;) i32 (i32.const 11832))
  (global (;25;) i32 (i32.const 1024))
  (global (;26;) i32 (i32.const 77376))
