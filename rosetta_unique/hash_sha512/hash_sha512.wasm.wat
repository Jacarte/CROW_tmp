(module
  ...
  (func $frexp (type 15) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $crypto_hash_sha512_bytes (type 11) (result i32)
    (i32.const 64))
  (func $crypto_hash_sha512_statebytes (type 11) (result i32)
    (i32.const 208))
  (table (;0;) 5 5 funcref)
  (memory (;0;) 2)
  ...
  (export "crypto_hash_sha512_bytes" (func $crypto_hash_sha512_bytes))
  (export "crypto_hash_sha512_statebytes" (func $crypto_hash_sha512_statebytes))
