(module
  ...
  (func $puts (type 5) (param i32) (result i32)
    ...
    (i32.shr_s
      (call $__overflow
        ...
        (i32.const 10))
      (i32.const 31)))
  (func $numPrimeFactors (type 5) (param i32) (result i32)
    (local i32 i32 i32)
    (local.set 1
      (i32.const 1))
    (block  ;; label = @1
      ...
      (loop  ;; label = @2
        ...
        (br 0 (;@3;))))
    (local.get 1))
  (func $primeFactors (type 10) (param i32 i32)
    (local i32 i32 i32)
    (block  ;; label = @1
      (block  ;; label = @2
        (br_if 0 (;@2;)
      ...
      (i32.store
        (local.get 1)
        (i32.const 1))))
  (func $sumDigits (type 5) (param i32) (result i32)
    (local i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (local.get 0))
    ...
    (loop  ;; label = @2
      ...
      (br_if 0 (;@2;)
        (local.get 3)))
    (local.get 1))
  (func $sumFactors (type 3) (param i32 i32) (result i32)
    (local i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
        ...
        (br_if 0 (;@2;)
          (local.tee 1
            (i32.add
              ...
              (i32.const -1))))))
    (local.get 2))
  (func $listAllSmithNumbers (type 2) (param i32)
    (local i32 i32 i32 i32)
    (global.set 0
      (local.tee 1
        (i32.sub
  ...
  (global (;17;) i32 (i32.const 3792))
  (global (;18;) i32 (i32.const 3560))
  ...
  (export "numPrimeFactors" (func $numPrimeFactors))
  (export "primeFactors" (func $primeFactors))
  (export "sumDigits" (func $sumDigits))
  (export "sumFactors" (func $sumFactors))
  (export "listAllSmithNumbers" (func $listAllSmithNumbers))
