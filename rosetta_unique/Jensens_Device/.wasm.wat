(module
  ...
  (func $polybench_timer_start (type 8)
    ...
    (f64.store offset=3792
      ...
      (local.get 0))
    (return))
  (func $rtclock (type 2) (result f64)
    (local i32 f64)
    (local.set 0
      (i32.const 0))
    (local.set 1
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $term_func (type 2) (result f64)
    (f64.div
      (f64.const 0x1p+0 (;=1;))
      (f64.convert_i32_s
        (i32.load offset=5416
          (i32.const 0)))))
  (func $sum (type 16) (param i32 i32 i32 i32) (result f64)
    (local f64 f64)
    (i32.store
      (local.get 0)
      (local.get 1))
  ...
  (export "sum" (func $sum))
  (export "term_func" (func $term_func))
  (export "i" (global 21))
