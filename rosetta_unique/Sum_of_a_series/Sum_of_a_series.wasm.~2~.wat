(module
  ...
  (func $frexp (type 15) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $Invsqr (type 16) (param f64) (result f64)
    (f64.div
      (f64.const 0x1p+0 (;=1;))
      (f64.mul
        (local.get 0)
