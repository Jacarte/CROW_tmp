(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 32)))
    (i32.const 0))
  (func $biased (type 4) (param i32) (result i32)
    (local i32 i32)
    (local.set 1
      (i32.xor
        (i32.rem_s
    ...
    (i32.lt_s
      ...
      (i32.div_s
        (local.get 1)
        (local.get 0))))
  (func $unbiased (type 4) (param i32) (result i32)
    (local i32)
    (loop  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eq
  ...
  (export "biased" (func $biased))
  (export "unbiased" (func $unbiased))
