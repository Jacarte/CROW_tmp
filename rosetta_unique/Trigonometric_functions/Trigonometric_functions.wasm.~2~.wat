    ...
    (i64.store
      (i32.add
        (i32.add
          ...
          (i32.const 32))
        (i32.const 8))
      (i64.const 4631530004285489151))
    (i64.store offset=32
      (local.get 0)
      (i64.const 4605249457297304855))
    (drop
      (call $printf
        (i32.const 3520)
        (i32.add
