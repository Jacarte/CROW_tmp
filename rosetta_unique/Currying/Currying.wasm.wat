(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 112)))
    (i32.const 0))
  (func $sumOfFactorials (type 5) (param i32 i32) (result i32)
    (local i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (local.get 1))
  (func $factorial (type 4) (param i32) (result i32)
    (local i32)
    (local.set 1
      (i32.const 1))
    (block  ;; label = @1
  ...
  (export "sumOfFactorials" (func $sumOfFactorials))
