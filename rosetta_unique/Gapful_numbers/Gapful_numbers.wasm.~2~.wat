(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (drop
      (call $printf
        ...
        (i32.const 0)))
    (i32.const 0))
  (func $generateGaps (type 16) (param i64 i32)
    (local i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
  ...
  (export "generateGaps" (func $generateGaps))
