(module
  ...
  (func $__original_main (type 12) (result i32)
    (call $move
      ...
      (i32.const 3))
    (i32.const 0))
  (func $move (type 11) (param i32 i32 i32 i32)
    (local i32)
    (global.set 0
      (local.tee 4
        (i32.sub
