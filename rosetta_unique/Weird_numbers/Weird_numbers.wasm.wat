(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $sieve (type 4) (param i32) (result i32)
    (local i32 i32 i32 i32)
    (global.set 0
      (local.tee 1
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 32)))
    (local.get 2))
  (func $divisors (type 10) (param i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    (local.set 3
      (call $malloc
        (local.tee 2
    ...
    (call $free
      (local.get 4)))
  (func $abundant (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
    ...
    (i32.and
      (i32.gt_s
        ...
        (local.get 0))
      (i32.const 1)))
  (func $semiperfect (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
  ...
  (export "divisors" (func $divisors))
  (export "abundant" (func $abundant))
  (export "semiperfect" (func $semiperfect))
