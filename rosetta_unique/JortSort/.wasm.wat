(module
  ...
  (func $puts (type 5) (param i32) (result i32)
    ...
    (i32.shr_s
      (call $__overflow
        ...
        (i32.const 10))
      (i32.const 31)))
  (func $number_of_digits (type 5) (param i32) (result i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (local.get 0))
    ...
    (loop  ;; label = @2
      ...
      (br_if 0 (;@2;)
        (i32.gt_u
          ...
          (i32.const 18))))
    (local.get 1))
  (func $convert_array (type 3) (param i32 i32) (result i32)
    (local i32 i32 i32 i32)
    (local.set 2
      (call $malloc
        (i32.shl
        ...
        (br_if 0 (;@2;)
          (local.tee 1
            (i32.add
              ...
              (i32.const -1))))))
    (local.get 2))
  (func $isSorted (type 3) (param i32 i32) (result i32)
    (local i32 i32)
    (local.set 2
      (i32.const 1))
    (block  ;; label = @1
  ...
  (export "number_of_digits" (func $number_of_digits))
  (export "convert_array" (func $convert_array))
  (export "isSorted" (func $isSorted))
