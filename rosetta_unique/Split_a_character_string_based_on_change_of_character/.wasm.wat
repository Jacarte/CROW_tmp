(module
  ...
  (func $main (type 3) (param i32 i32) (result i32)
    ...
    (i64.store offset=5 align=1
      (local.get 2)
      (i64.load offset=3525 align=1
        (i32.const 0)))
    (i64.store
      (local.get 2)
      (i64.load offset=3520 align=1
        (i32.const 0)))
    (drop
      (call $puts
        (call $split
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $split (type 5) (param i32) (result i32)
    (local i32 i32 i32 i32)
    (local.set 1
      (i32.load8_u
        (local.get 0)))
          ...
          (i32.store8
            (local.tee 1
              (i32.add
                (local.get 3)
                (i32.const 2)))
            (i32.load8_u offset=3535
              (i32.const 0)))
          (i32.store16 align=1
            (local.get 3)
            (i32.load16_u offset=3533 align=1
              (i32.const 0)))
          (local.set 4
            (i32.load8_u
              (local.get 0))))
