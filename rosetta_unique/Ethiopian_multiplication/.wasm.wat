(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $ethiopian (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32)
    (global.set 0
      (local.tee 3
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 48)))
    (local.get 0))
  (func $iseven (type 4) (param i32) (result i32)
    (i32.and
      (i32.eqz
        (i32.and
          (local.get 0)
  ...
  (export "doublit" (func $doublit))
  (export "iseven" (func $iseven))
  (export "ethiopian" (func $ethiopian))
