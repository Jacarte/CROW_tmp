(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 48)))
    (i32.const 0))
  (func $bogosort (type 10) (param i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (call $is_sorted
          (local.get 0)
        ...
        (br_if 0 (;@2;)
          (i32.eqz
            (call $is_sorted
              (local.get 0)
              (local.get 1)))))))
  (func $is_sorted (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32)
    (local.set 2
      (i32.const 1))
    (local.set 3
    ...
    (block  ;; label = @1
      ...
      (local.set 2
        (i32.const 0)))
    (local.get 2))
  (func $shuffle (type 10) (param i32 i32)
    (local i32 i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.lt_s
  ...
  (export "is_sorted" (func $is_sorted))
  (export "shuffle" (func $shuffle))
  (export "bogosort" (func $bogosort))
