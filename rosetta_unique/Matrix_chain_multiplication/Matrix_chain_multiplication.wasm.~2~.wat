(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (loop  ;; label = @1
              ...
              (i32.ne
                ...
                (local.tee 6
                  (i32.add
                    ...
                    (i32.const 1))))
              (i32.const 1)))))
      (call $optimal_matrix_chain_order
        (i32.load
          (i32.add
            (i32.add
              (local.get 0)
      ...
      (drop
        (call $printf
          (i32.const 3679)
          (i32.const 0)))
      (call $print_optimal_chain_order
        (i32.const 0)
        (local.tee 6
          (i32.sub
            (local.get 3)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 176)))
    (i32.const 0))
  (func $optimal_matrix_chain_order (type 10) (param i32 i32)
        ...
        (br_if 0 (;@11;)
          (i32.and
            (i32.lt_s
              ...
              (local.get 2))
            (i32.const 1))))))
  (func $print_optimal_chain_order (type 10) (param i32 i32)
    (local i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
  ...
  (global (;21;) i32 (i32.const 5592))
  (global (;22;) i32 (i32.const 5596))
  (global (;23;) i32 (i32.const 1024))
  (global (;24;) i32 (i32.const 5600))
  (global (;25;) i32 (i32.const 1024))
  (global (;26;) i32 (i32.const 71136))
  ...
  (export "optimal_matrix_chain_order" (func $optimal_matrix_chain_order))
  (export "print_optimal_chain_order" (func $print_optimal_chain_order))
  (export "m" (global 21))
  (export "s" (global 22))
