  ...
  (func $puts (type 4) (param i32) (result i32)
    ...
    (i32.shr_s
      (call $__overflow
        ...
        (i32.const 10))
      (i32.const 31)))
  (func $fmod (type 16) (param f64 f64) (result f64)
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 32)))
    (i32.const 0))
  (func $pascal (type 17) (param i32 i32 i32 i32 i32 i32 i32)
    (local f64)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (f64.ge
