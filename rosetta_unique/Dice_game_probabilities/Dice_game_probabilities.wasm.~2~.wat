(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 32)))
    (i32.const 0))
  (func $beating_probability (type 16) (param i32 i32 i32 i32) (result f64)
    (local i32 i32 i32 i32 i32 i32 i64 i64 f64 f64 f64)
    (local.set 5
      (local.tee 4
        (global.get 0)))
    (local.set 6
    ...
    (global.set 0
      (local.get 5))
    (local.get 12))
  (func $throw_die (type 11) (param i32 i32 i32 i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
            ...
            (i32.ne
              ...
              (local.tee 1
                (i32.add
                  ...
                  (i32.const 1))))
            (i32.const 1))))))
  (func $ipow (type 17) (param i32 i32) (result i64)
    (local i64 i64)
    (local.set 2
      (i64.const 1))
    (block  ;; label = @1
      ...
      (loop  ;; label = @2
        ...
        (br_if 0 (;@2;)
          (i32.and
            ...
            (i32.const 1)))))
    (local.get 2))
  (func $min (type 5) (param i32 i32) (result i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
          (i32.lt_u
  ...
  (export "ipow" (func $ipow))
  (export "min" (func $min))
  (export "throw_die" (func $throw_die))
  (export "beating_probability" (func $beating_probability))
