(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 32)))
    (i32.const 0))
  (func $multifact (type 5) (param i32 i32) (result i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.le_s
          (local.get 0)
      ...
      (local.set 0
        (i32.mul
          ...
          (local.get 0))))
    (local.get 0))
  (func $multifact_i (type 5) (param i32 i32) (result i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.le_s
  ...
  (export "multifact" (func $multifact))
  (export "multifact_i" (func $multifact_i))
