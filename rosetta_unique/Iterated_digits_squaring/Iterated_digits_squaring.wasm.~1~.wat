  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 20784)))
    (i32.const 0))
  (func $is89 (type 4) (param i32) (result i32)
    (local i32 i32 i32 i32)
    (loop  ;; label = @1
      (local.set 1
        (i32.const 0))
