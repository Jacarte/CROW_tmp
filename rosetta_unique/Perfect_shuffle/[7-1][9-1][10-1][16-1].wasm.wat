(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (local.get 2))
  (func $CreateDeck (type 5) (param i32 i32) (result i32)
    (local i32 i32)
    (local.set 2
      (i32.const 0))
    (local.set 3
    ...
    (block  ;; label = @2
      ...
      (local.set 2
        (i32.const 1)))
    (local.get 2))
  (func $InitDeck (type 10) (param i32 i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
          ...
          (i32.ne
            ...
            (local.tee 2
              (i32.add
                (local.get 2)
                (i32.const 1))))))))
  (func $ShuffleDeck (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (local.get 3))
  (func $InitedDeck (type 5) (param i32 i32) (result i32)
    (local i32 i32)
    (local.set 2
      (i32.const 1))
    (block  ;; label = @1
      ...
      (local.set 2
        (i32.const 1)))
    (local.get 2))
  (func $FreeDeck (type 2) (param i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
      ...
      (i32.store
        (local.get 0)
        (i32.const 0))))
  (func $DuplicateDeck (type 0) (param i32 i32 i32) (result i32)
    (local i32)
    (local.set 3
      (i32.const 0))
    (block  ;; label = @1
  ...
  (global (;23;) i32 (i32.const 5508))
  (global (;24;) i32 (i32.const 1024))
  (global (;25;) i32 (i32.const 71056))
  ...
  (export "CreateDeck" (func $CreateDeck))
  (export "InitDeck" (func $InitDeck))
  (export "ShuffleDeck" (func $ShuffleDeck))
  (export "InitedDeck" (func $InitedDeck))
  (export "FreeDeck" (func $FreeDeck))
  (export "DuplicateDeck" (func $DuplicateDeck))
  (export "kDecks" (global 21))
