(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 112)))
    (i32.const 0))
  (func $to_bt (type 10) (param i32 i32)
    (local i32 i32)
    (i32.store8
      (local.get 1)
      (i32.const 0))
    ...
    (call $reverse
      (local.get 1)))
  (func $subtract (type 14) (param i32 i32 i32)
    (local i32)
    (global.set 0
      (local.tee 3
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 3)
        (i32.const 16))))
  (func $mult (type 14) (param i32 i32 i32)
    (local i32 i32)
    (global.set 0
      (local.tee 3
        (i32.sub
    ...
    (loop  ;; label = @1
      ...
      (local.set 0
        (i32.add
          ...
          (i32.const 1)))
      (br 0 (;@5;))))
  (func $from_bt (type 4) (param i32) (result i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (local.tee 1
          ...
          (i32.lt_u
            ...
            (local.tee 1
              (i32.add
                (local.get 1)
                (i32.const -1))))))))
  (func $unary_minus (type 10) (param i32 i32)
    (local i32 i32)
    (loop  ;; label = @1
      (local.set 2
        (i32.const 43))
  ...
  (func $add (type 14) (param i32 i32 i32)
          ...
          (block  ;; label = @4
            (block  ;; label = @5
              (block  ;; label = @6
                (block  ;; label = @7
                  (block  ;; label = @8
                    (br_table 1 (;@7;) 4 (;@4;) 0 (;@8;) 4 (;@4;) 4 (;@4;) 2 (;@6;) 4 (;@4;)
                      (i32.add
                        (i32.and
                          (local.tee 4
                            (select
                  ...
                  (block  ;; label = @9
                    ...
                    (i32.store16 offset=12
                      (local.get 3)
                      (i32.const 11563)))
                  (br_table 0 (;@11;) 3 (;@8;) 3 (;@8;) 3 (;@8;) 3 (;@8;) 1 (;@10;) 3 (;@8;)
                    (i32.add
                      (i32.and
                        (local.get 4)
                        (i32.const 255))
                ...
                (block  ;; label = @12
                  (block  ;; label = @13
                    (block  ;; label = @14
                      (block  ;; label = @15
                        (br_table 2 (;@13;) 3 (;@12;) 1 (;@14;) 3 (;@12;) 3 (;@12;) 0 (;@15;) 3 (;@12;)
                          (i32.add
                            (i32.and
                              (local.get 7)
                              (i32.const 255))
    ...
    (global.set 0
      (i32.add
        (local.get 3)
        (i32.const 80))))
  (func $last_char (type 4) (param i32) (result i32)
    (local i32 i32)
    (local.set 1
      (i32.const 0))
    (block  ;; label = @1
  ...
  (export "to_bt" (func $to_bt))
  (export "from_bt" (func $from_bt))
  (export "last_char" (func $last_char))
  (export "add" (func $add))
  (export "unary_minus" (func $unary_minus))
