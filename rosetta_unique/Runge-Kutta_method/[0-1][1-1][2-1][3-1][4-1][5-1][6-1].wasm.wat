(module
  ...
  (type (;17;) (func (param i32 f64 f64 f64) (result f64)))
  ...
  (func $rate (type 2) (param f64 f64) (result f64)
    (f64.mul
      (f64.sqrt
        (local.get 1))
      (local.get 0)))
  (func $rk4 (type 17) (param i32 f64 f64 f64) (result f64)
    (local f64 f64)
    (local.set 4
      (f64.add
        (f64.mul
