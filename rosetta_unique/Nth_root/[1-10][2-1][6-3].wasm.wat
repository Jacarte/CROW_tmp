  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 32)))
    (i32.const 0))
  (func $pow_ (type 15) (param f64 i32) (result f64)
    (local f64)
    (local.set 2
      (f64.const 0x1p+0 (;=1;)))
    (block  ;; label = @1
        ...
        (br_if 0 (;@2;)
          (local.tee 1
            (i32.add
              ...
              (i32.const -1))))))
    (local.get 2))
  (func $root (type 16) (param i32 f64) (result f64)
