  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 304)))
    (i32.const 0))
  (func $sput (type 3) (param i32 i32) (result i32)
    (local i32)
    (i32.store
      (local.tee 2
        (i32.add
    ...
    (block  ;; label = @1
      ...
      (i32.store offset=12
        ...
        (i32.const 0)))
    (i32.const 0))
  (func $sget (type 2) (param i32) (result i32)
    (local i32 i32 i32)
    (local.set 1
      (i32.const -1))
    (block  ;; label = @1
      ...
      (local.set 1
        (local.get 3)))
    (local.get 1))
  (func $file_put (type 3) (param i32 i32) (result i32)
    (call $fputc
      (local.get 1)
      (i32.load offset=8
        (local.get 0))))
  (func $encode (type 10) (param i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 2)
        (i32.const 256))))
  (func $decode (type 10) (param i32 i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eq
            ...
            (local.tee 2
              (call_indirect (type 2)
                ...
                (i32.load
                  (local.get 0))))
            (i32.const -1))))))
  (func $output (type 14) (param i32 i32 i32)
    (drop
      (call_indirect (type 3)
        (local.get 0)
        (i32.add
