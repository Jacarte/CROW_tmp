  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 80)))
    (i32.const 0))
  (func $heapsort (type 10) (param i32 i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
        ...
        (br_if 0 (;@4;)
          (i32.and
            (i32.ne
              ...
              (i32.const -1))
            (i32.const 1))))))
  (func $downheap (type 14) (param i32 i32 i32)
    (local i32 i32 i32)
    (block  ;; label = @1
      (loop  ;; label = @2
        (local.set 3
      ...
      (return))
    (unreachable))
  (func $max (type 13) (param i32 i32 i32 i32 i32) (result i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
          (i32.xor
