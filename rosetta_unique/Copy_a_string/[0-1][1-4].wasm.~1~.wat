  ...
  (func $__original_main (type 12) (result i32)
    ...
    (i32.store16
      (i32.add
        (local.get 0)
        (i32.const 252))
      (i32.load16_u offset=3524 align=1
        (i32.const 0)))
    (i32.store offset=248
      (local.get 0)
      (i32.load offset=3520 align=1
        (i32.const 0)))
    (local.set 1
      (call $strcpy
        (i32.add
