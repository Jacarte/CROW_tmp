(module
  ...
  (func $add (type 2) (param i32 i32) (result i32)
    (i32.add
      (local.get 1)
      (local.get 0)))
  (func $reduce (type 0) (param i32 i32 i32) (result i32)
    (local i32)
    (local.set 3
      (i32.load
        (local.get 2)))
