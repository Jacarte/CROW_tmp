(module
  ...
  (func $c2qi (type 14) (param i32 i32 i32)
    (local i32 f64 i32 i32 i32 i32 i32 f64)
    (global.set 0
      (local.tee 3
        (i32.sub
          (global.get 0)
