(module
    ...
    (block  ;; label = @1
      ...
      (local.set 3
        (i32.sub
          ...
          (local.get 5))))
    (local.get 3))
  (func $strstr (type 5) (param i32 i32) (result i32)
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 48)))
    (i32.const 0))
  (func $startsWith (type 5) (param i32 i32) (result i32)
    (local i32 i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
      ...
      (local.set 2
        (i32.and
          ...
          (i32.const 1))))
    (local.get 2))
  (func $endsWith (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
      ...
      (local.set 2
        (i32.and
          ...
          (i32.const 1))))
    (local.get 2))
  (func $doesContain (type 5) (param i32 i32) (result i32)
    (i32.and
      (i32.ne
        (call $strstr
          (local.get 0)
  ...
  (export "startsWith" (func $startsWith))
  (export "endsWith" (func $endsWith))
  (export "doesContain" (func $doesContain))
