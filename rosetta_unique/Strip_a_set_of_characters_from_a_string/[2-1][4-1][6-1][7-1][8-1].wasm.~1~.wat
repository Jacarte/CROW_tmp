(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $strip_chars (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32)
    (local.set 2
      (call $malloc
        (i32.add
  ...
  (export "strip_chars" (func $strip_chars))
