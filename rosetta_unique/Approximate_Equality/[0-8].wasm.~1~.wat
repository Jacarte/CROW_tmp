(module
  ...
  (type (;16;) (func (param f64 f64)))
  (type (;17;) (func (param f64 f64 f64) (result i32)))
  ...
  (func $__original_main (type 12) (result i32)
    (call $test
      (f64.const 0x1.6bcc41e900001p+46 (;=1e+14;))
      (f64.const 0x1.6bcc41e900001p+46 (;=1e+14;)))
    (call $test
      (f64.const 0x1.900a3d70a3d71p+6 (;=100.01;))
      (f64.const 0x1.900b439581062p+6 (;=100.011;)))
    (call $test
      (f64.const 0x1.dcd6500000002p+29 (;=1e+09;))
      (f64.const 0x1.dcd6500000001p+29 (;=1e+09;)))
    (call $test
      (f64.const 0x1.0624dd2f1a9fcp-10 (;=0.001;))
      (f64.const 0x1.0624dee6e89d6p-10 (;=0.001;)))
    (call $test
      (f64.const 0x1.e867f1a7e012p-74 (;=1.01e-22;))
      (f64.const 0x0p+0 (;=0;)))
    (call $test
      (f64.const 0x1.0000000000001p+1 (;=2;))
      (f64.const 0x1p+1 (;=2;)))
    (call $test
      (f64.const -0x1.0000000000001p+1 (;=-2;))
      (f64.const -0x1p+1 (;=-2;)))
    (call $test
      ...
      (f64.const 0x1.921fb54442d18p+1 (;=3.14159;)))
    (i32.const 0))
  (func $test (type 16) (param f64 f64)
    (local i32)
    (global.set 0
      (local.tee 2
        (i32.sub
      ...
      (select
        ...
        (i32.and
          (call $approxEquals
            (local.get 0)
            (local.get 1)
            (f64.const 0x1.2725dd1d243acp-60 (;=1e-18;)))
          (i32.const 1))))
    (f64.store
      (local.get 2)
      (local.get 0))
    ...
    (global.set 0
      (i32.add
        (local.get 2)
        (i32.const 32))))
  (func $approxEquals (type 17) (param f64 f64 f64) (result i32)
    (i32.and
      (f64.lt
        (f64.abs
          (f64.sub
  ...
  (export "approxEquals" (func $approxEquals))
