(module
  ...
  (func $__ashlti3 (type 16) (param i32 i64 i64 i32)
    ...
    (i64.store offset=8
      (local.get 0)
      (local.get 2)))
  (func $__extenddftf2 (type 17) (param i32 f64)
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 2608)))
    (i32.const 0))
  (func $det (type 19) (param i32 i32) (result f64)
    ...
    (global.set 0
      (local.get 3))
    (local.get 8))
  (func $showmat (type 14) (param i32 i32 i32)
    (local i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 3
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 3)
        (i32.const 32))))
  (func $trianglize (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i64 i64 i32 i32 f64)
    (global.set 0
      (local.tee 2
        (i32.sub
          (global.get 0)
  ...
  (export "showmat" (func $showmat))
  (export "trianglize" (func $trianglize))
  (export "det" (func $det))
