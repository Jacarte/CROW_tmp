(module
  ...
  (func $best_match (type 5) (param i32 i32) (result i32)
    (local f64 i32 i32 f64 i32 i32 f64 i32 i32 f64 f64)
    (local.set 2
      (f64.const 0x0p+0 (;=0;)))
    (local.set 3
      (i32.const 0))
  ...
  (table (;0;) 5 5 funcref)
  (memory (;0;) 2)
  (global (;0;) (mut i32) (i32.const 72208))
