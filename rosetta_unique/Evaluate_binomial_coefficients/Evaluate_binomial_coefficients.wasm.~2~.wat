      ...
      (loop  ;; label = @5
        ...
        (br_if 0 (;@8;)
          (i32.and
            ...
            (i32.const 1)))))
    (local.get 2))
  (func $gcd_ui (type 5) (param i32 i32) (result i32)
    (local i32)
    (block  ;; label = @1
      (block  ;; label = @2
        (br_if 0 (;@2;)
