(module
  ...
  (import "env" "main" (func $main (type 4)))
  ...
  (import "env" "_sodium_runtime_get_cpu_features" (func $_sodium_runtime_get_cpu_features (type 8)))
  (import "env" "randombytes_stir" (func $randombytes_stir (type 2)))
  (import "env" "_sodium_alloc_init" (func $_sodium_alloc_init (type 8)))
  (import "env" "_crypto_pwhash_argon2_pick_best_implementation" (func $_crypto_pwhash_argon2_pick_best_implementation (type 8)))
  (import "env" "_crypto_generichash_blake2b_pick_best_implementation" (func $_crypto_generichash_blake2b_pick_best_implementation (type 8)))
  (import "env" "_crypto_onetimeauth_poly1305_pick_best_implementation" (func $_crypto_onetimeauth_poly1305_pick_best_implementation (type 8)))
  (import "env" "_crypto_scalarmult_curve25519_pick_best_implementation" (func $_crypto_scalarmult_curve25519_pick_best_implementation (type 8)))
  (import "env" "_crypto_stream_chacha20_pick_best_implementation" (func $_crypto_stream_chacha20_pick_best_implementation (type 8)))
  (import "env" "_crypto_stream_salsa20_pick_best_implementation" (func $_crypto_stream_salsa20_pick_best_implementation (type 8)))
  (import "wasi_snapshot_preview1" "poll_oneoff" (func $__wasi_poll_oneoff (type 7)))
  (func $__wasm_call_ctors (type 2))
  (func $polybench_flush_cache (type 2)
    ...
    (global.set 0
      (local.get 38))
    (return))
  (func $polybench_prepare_instruments (type 2)
    (call $polybench_flush_cache)
    (return))
  (func $polybench_timer_start (type 2)
    (local f64 i32)
  ...
  (func $rtclock (type 9) (result f64)
    ...
    (return
      (local.get 1)))
  (func $polybench_timer_stop (type 2)
    (local f64 i32)
    (local.set 0
      (call $rtclock))
    (local.set 1
    ...
    (f64.store offset=3800
      ...
      (local.get 0))
    (return))
  (func $polybench_timer_print (type 2)
  ...
  (func $sbrk (type 6) (param i32) (result i32)
    ...
    (call $abort)
    (unreachable))
  (func $main.1 (type 4) (param i32 i32) (result i32)
    (call $main
      (local.get 0)
      (local.get 1)))
  ...
  (func $pop_arg (type 14) (param i32 i32 i32)
    (block  ;; label = @1
      ...
      (i32.store
        ...
        (i32.load
          (local.get 1)))))
  (func $long_double_not_supported (type 2)
    (drop
      (call $fputs
        (i32.const 3312)
        (i32.const 3528)))
    ...
    (i32.store offset=16
      ...
      (i32.add
        ...
        (i32.load offset=44
          (local.get 0))))
    (i32.const 0))
  (func $__towrite_needs_stdio_exit (type 2)
    (call $__stdio_exit))
  ...
  (func $__udivmodti4 (type 17) (param i32 i64 i64 i64 i64 i32)
    ...
    (i64.store offset=8
      (local.get 0)
      (local.get 2)))
  (func $__udivti3 (type 16) (param i32 i64 i64 i64 i64)
    (local i32)
    (global.set 0
      (local.tee 5
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 5)
        (i32.const 16))))
  (func $__divti3 (type 16) (param i32 i64 i64 i64 i64)
    (local i32 i64)
    (global.set 0
      (local.tee 5
        (i32.sub
  ...
  (func $clock_nanosleep (type 7) (param i32 i32 i32 i32) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 112)))
    (local.get 5))
  (func $nanosleep (type 4) (param i32 i32) (result i32)
    (local i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
      ...
      (local.set 2
        (i32.const -1)))
    (local.get 2))
  (func $sodium_init (type 8) (result i32)
    (local i32 i32 i32)
    (global.set 0
      (local.tee 0
        (i32.sub
    ...
    (block  ;; label = @3
      (br_if 0 (;@3;)
        (i32.and
          (i32.xor
            (i32.eqz
              (i32.load offset=5420
                (i32.const 0)))
            (i32.const 1))
          (i32.const 1)))
      (drop
        (call $_sodium_runtime_get_cpu_features))
      (call $randombytes_stir)
      (drop
        (call $_sodium_alloc_init))
      (drop
        (call $_crypto_pwhash_argon2_pick_best_implementation))
      (drop
        (call $_crypto_generichash_blake2b_pick_best_implementation))
      (drop
        (call $_crypto_onetimeauth_poly1305_pick_best_implementation))
      (drop
        (call $_crypto_scalarmult_curve25519_pick_best_implementation))
      (drop
        (call $_crypto_stream_chacha20_pick_best_implementation))
      (drop
        (call $_crypto_stream_salsa20_pick_best_implementation))
      (local.set 2
        (i32.const 0))
      (i32.store offset=5420
        (i32.const 0)
        (i32.const 1)))
    (i32.store offset=5416
      (i32.const 0)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (local.get 2))
  (func $sodium_crit_enter (type 8) (result i32)
    (local i32 i32)
    (global.set 0
      (local.tee 0
        (i32.sub
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 16)))
    (i32.const 0))
  (func $sodium_crit_leave (type 8) (result i32)
    (i32.store offset=5416
      (i32.const 0)
      (i32.const 0))
    (i32.const 0))
  (func $sodium_misuse (type 2)
    (local i32 i32)
    (global.set 0
      (local.tee 0
        (i32.sub
    ...
    (call $abort)
    (unreachable))
  (func $sodium_set_misuse_handler (type 6) (param i32) (result i32)
    (local i32 i32)
    (global.set 0
      (local.tee 1
        (i32.sub
  ...
  (global (;10;) i32 (i32.const 3528))
  (global (;11;) i32 (i32.const 4332))
  (global (;12;) i32 (i32.const 4336))
  (global (;13;) i32 (i32.const 4340))
  (global (;14;) i32 (i32.const 4368))
  (global (;15;) i32 (i32.const 4332))
  (global (;16;) i32 (i32.const 4336))
  (global (;17;) i32 (i32.const 3648))
  (global (;18;) i32 (i32.const 3760))
  (global (;19;) i32 (i32.const 3640))
  (global (;20;) i32 (i32.const 4380))
  (global (;21;) i32 (i32.const 3516))
  (global (;22;) i32 (i32.const 1024))
  (global (;23;) i32 (i32.const 5428))
  (global (;24;) i32 (i32.const 1024))
  (global (;25;) i32 (i32.const 70976))
  ...
  (export "_CLOCK_REALTIME" (global 9))
  ...
  (export "sodium_init" (func $sodium_init))
  (export "sodium_crit_enter" (func $sodium_crit_enter))
  (export "sodium_crit_leave" (func $sodium_crit_leave))
  (export "sodium_misuse" (func $sodium_misuse))
  (export "sodium_set_misuse_handler" (func $sodium_set_misuse_handler))
