(module
  ...
  (type (;20;) (func (param i32 i32 f64 f64 i32)))
  (type (;21;) (func (param f64 f64 f64 f64 f64) (result f64)))
  (type (;22;) (func (param f64 i32 f64 f64 i32) (result f64)))
  ...
  (func $test_func (type 2) (param f64) (result f64)
    (call $cos
      (local.get 0)))
  (func $cheb_coef (type 20) (param i32 i32 f64 f64 i32)
          ...
          (i32.ne
            (local.tee 5
              (i32.add
                ...
                (i32.const 1)))
            (local.get 1))))))
  (func $map (type 21) (param f64 f64 f64 f64 f64) (result f64)
    (f64.add
      (f64.mul
        (f64.div
          (f64.sub
        ...
        (f64.sub
          ...
          (local.get 3)))
      (local.get 3)))
  (func $cheb_approx (type 22) (param f64 i32 f64 f64 i32) (result f64)
    (local f64 f64)
    (local.set 5
      (f64.const 0x1p+0 (;=1;)))
    (local.set 2
  ...
  (global (;16;) i32 (i32.const 6600))
  (global (;17;) i32 (i32.const 6720))
