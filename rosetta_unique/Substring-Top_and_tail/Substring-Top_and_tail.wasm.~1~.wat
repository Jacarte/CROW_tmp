(module
  ...
  (func $main (type 3) (param i32 i32) (result i32)
    ...
    (i32.store align=1
      (local.get 4)
      (i32.const 1801678707))
    (i32.store align=1
      (local.get 5)
      (i32.const 1836019570))
    (i32.store16 align=1
      (i32.add
        (local.get 3)
        (i32.const 4))
      (i32.load16_u offset=3525 align=1
        (i32.const 0)))
    (i32.store align=1
      (local.get 3)
      (i32.load offset=3521 align=1
        (i32.const 0)))
    (i32.store offset=8
      (local.get 2)
      (local.get 5))
