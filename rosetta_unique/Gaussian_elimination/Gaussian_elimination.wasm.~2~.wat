(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (i64.store offset=64
      (local.get 0)
      (i64.const -4646453807550688133))
    (i64.store
      (local.get 5)
      (i64.const 4603669611090668421))
    (i64.store
      (local.get 4)
      (i64.const 4606371770867090719))
    (i64.store
      (local.get 3)
      (i64.const 4607092346807469998))
    (i64.store
      (local.get 2)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 400)))
    (i32.const 0))
  (func $gauss_eliminate (type 11) (param i32 i32 i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 f64 i32 i32 f64 i32 i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
          (i32.xor
        ...
        (br_if 0 (;@13;)
          (i32.and
            (i32.ge_s
              ...
              (i32.const 0))
            (i32.const 1))))))
  (func $swap_row (type 16) (param i32 i32 i32 i32 i32)
    (local i32 f64)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
  ...
  (export "swap_row" (func $swap_row))
  (export "gauss_eliminate" (func $gauss_eliminate))
