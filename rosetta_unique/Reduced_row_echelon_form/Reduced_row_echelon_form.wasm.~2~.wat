(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (call $MtxDisplay
      (local.get 0))
    (i32.const 0))
  (func $InitMatrix (type 0) (param i32 i32 i32) (result i32)
    (local i32)
    (local.set 3
      (i32.const 0))
    (local.set 0
      ...
      (loop  ;; label = @2
        ...
        (br_if 0 (;@2;)
          (i32.and
            ...
            (i32.const 1)))))
    (local.get 0))
  (func $MtxDisplay (type 2) (param i32)
    (local i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 1
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 1)
        (i32.const 16))))
  (func $MtxToReducedREForm (type 2) (param i32)
    (local i32 i32 i32 i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (local.tee 2
        ...
        (br_if 0 (;@9;)
          (i32.and
            (i32.lt_s
              ...
              (local.get 1))
            (i32.const 1))))))
  (func $NewMatrix (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32)
    (i32.store
      (local.tee 2
        (call $malloc
      ...
      (loop  ;; label = @2
        ...
        (br_if 0 (;@2;)
          (i32.and
            ...
            (i32.const 1)))))
    (local.get 2))
  (func $MtxSetRow (type 14) (param i32 i32 i32)
    (local i32)
    (local.set 3
      (i32.const 0))
    (block  ;; label = @1
          ...
          (i32.and
            (i32.lt_s
              ...
              (i32.load
                (local.get 0)))
            (i32.const 1))))))
  (func $MtxSwapRows (type 14) (param i32 i32 i32)
    (local i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
      ...
      (i32.store
        (local.get 1)
        (local.get 2))))
  (func $MtxNormalizeRow (type 14) (param i32 i32 i32)
    (local i32)
    (local.set 3
      (i32.const 0))
    (block  ;; label = @1
          ...
          (i32.and
            (i32.lt_s
              ...
              (i32.load
                (local.get 0)))
            (i32.const 1))))))
  (func $MtxMulAndAddRows (type 11) (param i32 i32 i32 i32)
    (local i32 i32)
    (local.set 4
      (i32.const 0))
    (block  ;; label = @1
  ...
  (global (;22;) i32 (i32.const 5512))
  (global (;23;) i32 (i32.const 1024))
  (global (;24;) i32 (i32.const 71056))
  ...
  (export "NewMatrix" (func $NewMatrix))
  (export "MtxSetRow" (func $MtxSetRow))
  (export "InitMatrix" (func $InitMatrix))
  (export "MtxDisplay" (func $MtxDisplay))
  (export "MtxMulAndAddRows" (func $MtxMulAndAddRows))
  (export "MtxSwapRows" (func $MtxSwapRows))
  (export "MtxNormalizeRow" (func $MtxNormalizeRow))
  (export "MtxToReducedREForm" (func $MtxToReducedREForm))
