(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 48)))
    (i32.const 0))
  (func $maxcat (type 10) (param i32 i32)
    (local i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 2)
        (i32.const 16))))
  (func $catcmp (type 2) (param i32 i32) (result i32)
    (local i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
  ...
  (export "catcmp" (func $catcmp))
  (export "maxcat" (func $maxcat))
