(module
  ...
  (type (;17;) (func (param i32 i32 i64 i32 i32) (result i32)))
  (type (;18;) (func (param i32 i32 i64 i32) (result i32)))
  (type (;19;) (func (param i32 i32 i32 i64 i32) (result i32)))
  ...
  (import "env" "sc25519_is_canonical" (func $sc25519_is_canonical (type 5)))
  (import "env" "ge25519_has_small_order" (func $ge25519_has_small_order (type 5)))
  (import "env" "ge25519_is_canonical" (func $ge25519_is_canonical (type 5)))
  (import "env" "ge25519_frombytes_negate_vartime" (func $ge25519_frombytes_negate_vartime (type 3)))
  (import "env" "_crypto_sign_ed25519_ref10_hinit" (func $_crypto_sign_ed25519_ref10_hinit (type 7)))
  (import "env" "crypto_hash_sha512_update" (func $crypto_hash_sha512_update (type 8)))
  (import "env" "crypto_hash_sha512_final" (func $crypto_hash_sha512_final (type 3)))
  (import "env" "sc25519_reduce" (func $sc25519_reduce (type 2)))
  (import "env" "ge25519_double_scalarmult_vartime" (func $ge25519_double_scalarmult_vartime (type 9)))
  (import "env" "ge25519_tobytes" (func $ge25519_tobytes (type 7)))
  (import "env" "crypto_verify_32" (func $crypto_verify_32 (type 3)))
  ...
  (func $exit (type 2) (param i32)
    ...
    (call $_Exit
      (local.get 0))
    (unreachable))
  (func $__assert_fail (type 9) (param i32 i32 i32 i32)
    (local i32)
    (global.set 0
      (local.tee 4
        (i32.sub
        ...
        (br_if 0 (;@17;)
          (local.tee 2
            (i32.add
              ...
              (i32.const -1))))))
    (local.get 0))
  (func $_crypto_sign_ed25519_verify_detached (type 17) (param i32 i32 i64 i32 i32) (result i32)
    (local i32 i32 i32)
    (global.set 0
      (local.tee 5
        (i32.sub
    ...
    (block  ;; label = @1
      ...
      (br_if 0 (;@1;)
        (i32.and
          (i32.xor
            (i32.eqz
              (call $ge25519_frombytes_negate_vartime
                (i32.add
                  (local.get 5)
                  (i32.const 128))
                (local.get 3)))
            (i32.const 1))
          (i32.const 1)))
      (call $_crypto_sign_ed25519_ref10_hinit
        (i32.add
          (local.get 5)
          (i32.const 384))
        (local.get 4))
      (drop
        (call $crypto_hash_sha512_update
          (i32.add
            (local.get 5)
            (i32.const 384))
          (local.get 0)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 592)))
    (local.get 6))
  (func $crypto_sign_ed25519_verify_detached (type 18) (param i32 i32 i64 i32) (result i32)
    (call $_crypto_sign_ed25519_verify_detached
      (local.get 0)
      (local.get 1)
      (local.get 2)
      (local.get 3)
      (i32.const 0)))
  (func $crypto_sign_ed25519_open (type 19) (param i32 i32 i32 i64 i32) (result i32)
    (local i32)
    (block  ;; label = @1
      (block  ;; label = @2
        (block  ;; label = @3
  ...
  (export "_crypto_sign_ed25519_verify_detached" (func $_crypto_sign_ed25519_verify_detached))
  (export "crypto_sign_ed25519_verify_detached" (func $crypto_sign_ed25519_verify_detached))
  (export "crypto_sign_ed25519_open" (func $crypto_sign_ed25519_open))
