(module
    ...
    (loop  ;; label = @1
      ...
      (br_if 0 (;@1;)
        (i32.and
          ...
          (i32.const 1))))
    (i32.const 0))
  (func $faulhaber (type 2) (param i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 1
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 1)
        (i32.const 128))))
  (func $makeFrac (type 14) (param i32 i32 i32)
    (local i32)
    (local.set 3
      (i32.const 1))
    (block  ;; label = @1
    ...
    (i32.store offset=4
      (local.get 0)
      (local.get 3)))
  (func $multFrac (type 14) (param i32 i32 i32)
    (call $makeFrac
      (local.get 0)
      (i32.mul
        (i32.load
      ...
      (i32.mul
        ...
        (i32.load offset=4
          (local.get 2)))))
  (func $binomial (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32)
    (local.set 2
      (i32.const -1))
    (block  ;; label = @1
      ...
      (local.set 2
        (i32.div_s
          ...
          (local.get 3))))
    (local.get 2))
  (func $bernoulli (type 10) (param i32 i32)
    (local i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 2)
        (i32.const 192))))
  (func $printFrac (type 2) (param i32)
    (local i32 i32)
    (global.set 0
      (local.tee 1
        (i32.sub
    ...
    (global.set 0
      (i32.add
        (local.get 1)
        (i32.const 32))))
  (func $gcd (type 5) (param i32 i32) (result i32)
    (local i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.eqz
    ...
    (loop  ;; label = @2
      ...
      (br_if 0 (;@2;)
        (i32.and
          ...
          (i32.const 1))))
    (local.get 2))
  (func $subFrac (type 14) (param i32 i32 i32)
    (local i32)
    (call $makeFrac
      (local.get 0)
      (i32.sub
      ...
      (i32.mul
        (local.get 3)
        (local.get 1))))
  (func $negateFrac (type 10) (param i32 i32)
    (call $makeFrac
      (local.get 0)
      (i32.sub
        (i32.const 0)
      ...
      (i32.load offset=4
        (local.get 1))))
  (func $equalFrac (type 5) (param i32 i32) (result i32)
    (local i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
    ...
    (i32.and
      (local.get 2)
      (i32.const 1)))
  (func $lessFrac (type 5) (param i32 i32) (result i32)
    (i32.and
      (i32.lt_s
        (i32.mul
          (i32.load
  ...
  (export "gcd" (func $gcd))
  (export "makeFrac" (func $makeFrac))
  (export "negateFrac" (func $negateFrac))
  (export "subFrac" (func $subFrac))
  (export "multFrac" (func $multFrac))
  (export "equalFrac" (func $equalFrac))
  (export "lessFrac" (func $lessFrac))
  (export "printFrac" (func $printFrac))
  (export "bernoulli" (func $bernoulli))
  (export "faulhaber" (func $faulhaber))
