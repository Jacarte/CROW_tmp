(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 272)))
    (i32.const 0))
  (func $create (type 5) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    (global.set 0
      (local.tee 2
        (i32.sub
      ...
      (loop  ;; label = @2
        ...
        (i32.store offset=28
          ...
          (i32.load offset=16
            (local.get 2)))
        (br 0 (;@4;)))))
  (func $state_index (type 5) (param i32 i32) (result i32)
    (local i32 i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
      ...
      (local.set 2
        (i32.const 0)))
    (local.get 2))
  (func $symbol_index (type 5) (param i32 i32) (result i32)
    (local i32 i32)
    (local.set 2
      (i32.const 0))
    (block  ;; label = @1
      ...
      (local.set 2
        (i32.const 0)))
    (local.get 2))
  (func $move (type 10) (param i32 i32)
    (local i32 i32)
    (local.set 2
      (i32.load offset=36
        (local.get 0)))
    (block  ;; label = @1
      ...
      (i32.store offset=4
        (local.get 2)
        (local.get 1))))
  (func $print_state (type 2) (param i32)
    (local i32 i32 i32)
    (global.set 0
      (local.tee 1
        (i32.sub
  ...
  (export "state_index" (func $state_index))
  (export "symbol_index" (func $symbol_index))
