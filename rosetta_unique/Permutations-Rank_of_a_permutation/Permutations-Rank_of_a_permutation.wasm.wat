(module
  ...
  (func $frexp (type 15) (param f64 i32) (result f64)
    ...
    (local.get 0))
  (func $_mr_unrank1 (type 14) (param i32 i32 i32)
    (local i32 i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.lt_s
      ...
      (local.set 3
        (i32.add
          ...
          (i32.mul
            ...
            (local.get 0)))))
    (local.get 3))
  (func $get_permutation (type 14) (param i32 i32 i32)
    (local i32 i32)
    (block  ;; label = @1
      (br_if 0 (;@1;)
        (i32.lt_s
