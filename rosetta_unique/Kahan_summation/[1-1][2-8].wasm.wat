(module
  ...
  (func $__original_main (type 12) (result i32)
    ...
    (global.set 0
      (i32.add
        ...
        (i32.const 64)))
    (i32.const 0))
  (func $epsilon (type 16) (result f32)
    (local f32)
    (local.set 0
      (f32.const 0x1p+0 (;=1;)))
    (loop  ;; label = @1
      (br_if 0 (;@1;)
        (i32.and
          ...
          (i32.const 1))))
    (local.get 0))
  (func $kahanSum (type 17) (param i32 i32) (result f32)
    (local f32 f32 f32)
    (local.set 2
      (f32.const 0x0p+0 (;=0;)))
    (block  ;; label = @1
  ...
  (export "epsilon" (func $epsilon))
  (export "kahanSum" (func $kahanSum))
